...
.method public run()V
    ...
    const-string v6, "system is not ready, just wait!"
    ...
    .end local v21           #triggerList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/AlarmManagerService$Alarm;>;"
    :cond_1
    ...
    .restart local v21       #triggerList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/AlarmManagerService$Alarm;>;"
    const/high16 v5, 0x1
    ...
    :cond_8
    invoke-static {}, Lcom/android/server/AlarmManagerService;->access$1108()I
    ...
    const-string v7, "+++Alarm  wakeup phone ,pkg="
