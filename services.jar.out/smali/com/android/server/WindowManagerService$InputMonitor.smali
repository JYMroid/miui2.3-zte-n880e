...
.method public notifyANR(Ljava/lang/Object;Landroid/view/InputChannel;)J
    ...
    iget-object v5, p0, Lcom/android/server/WindowManagerService$InputMonitor;->this$0:Lcom/android/server/WindowManagerService;

    iget-object v5, v5, Lcom/android/server/WindowManagerService;->mWindowMap:Ljava/util/HashMap;
    ...
    .local v4, windowState:Lcom/android/server/WindowManagerService$WindowState;
    if-eqz v4, :cond_0
    ...
    iget-object v7, v4, Lcom/android/server/WindowManagerService$WindowState;->mAttrs:Landroid/view/WindowManager$LayoutParams;
    ...
    .local v3, keyTimeoutDetail:Ljava/lang/String;
    const-string v6, "WindowManager"

    invoke-static {v6, v3}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    invoke-static {v3}, Landroid/util/ZteEventLog/ZteEventLog;->OnAnrInfo(Ljava/lang/String;)V

    iget-object v2, v4, Lcom/android/server/WindowManagerService$WindowState;->mAppToken:Lcom/android/server/WindowManagerService$AppWindowToken;

    .end local v3           #keyTimeoutDetail:Ljava/lang/String;
    :cond_0
    monitor-exit v5
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .end local v4           #windowState:Lcom/android/server/WindowManagerService$WindowState;
    :cond_1
    if-nez v2, :cond_2
    ...
    iget-object v6, v2, Lcom/android/server/WindowManagerService$WindowToken;->stringName:Ljava/lang/String;
    ...
    .restart local v3       #keyTimeoutDetail:Ljava/lang/String;
    ...
    iget-object v5, v2, Lcom/android/server/WindowManagerService$AppWindowToken;->appToken:Landroid/view/IApplicationToken;
    ...
    invoke-interface {v5}, Landroid/view/IApplicationToken;->keyDispatchingTimedOut()Z
    ...
    iget-wide v5, v2, Lcom/android/server/WindowManagerService$AppWindowToken;->inputDispatchingTimeoutNanos:J
    :try_end_1
