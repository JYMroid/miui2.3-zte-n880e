...
.field private static flagWakeup:I
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/server/AlarmManagerService;->flagWakeup:I
...
.method static synthetic access$1100()I
    ...
    .prologue
    sget v0, Lcom/android/server/AlarmManagerService;->flagWakeup:I
...
.method static synthetic access$1108()I
    ...
    sput v1, Lcom/android/server/AlarmManagerService;->flagWakeup:I
...
.method private native poweroffset(IIJJ)V
.end method

.method private poweroffsetLocked(Lcom/android/server/AlarmManagerService$Alarm;)V
    .locals 13
    .parameter "alarm"
    ...
    const-string v2, "in the poweroffsetLocked: mDescriptor  alarm.type  alarmSeconds   alarmNanoseconds="
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/server/AlarmManagerService;->poweroffset(IIJJ)V
...
.method private setLocked(Lcom/android/server/AlarmManagerService$Alarm;)V
    ...
    const-string v2, "in the set:mDescriptor  alarm.type  alarmSeconds   alarmNanoseconds="
...
.method public poweroffset(IJLandroid/app/PendingIntent;)V
    ...
    const-string v2, "in the poweroffset:type  triggerAtTime  operation="
    ...
    invoke-virtual/range {v0 .. v6}, Lcom/android/server/AlarmManagerService;->poweroffsetRepeating(IJJLandroid/app/PendingIntent;)V

    return-void
.end method

.method public poweroffsetRepeating(IJJLandroid/app/PendingIntent;)V
    .locals 7
    .parameter "type"
    .parameter "triggerAtTime"
    .parameter "interval"
    ...
    const-string v2, "+++Alarm poweroffsetRepeating:type="

    const-string v2, "  Trigger after:"
    ...
    const-string v2, "set/poweroffsetRepeating ignored because there is no intent"
    ...
    const-string v5, "+++Alarm poweroffsetRepeating:type="
    ...
    .local v1, index:I
    invoke-direct {p0, v0}, Lcom/android/server/AlarmManagerService;->poweroffsetLocked(Lcom/android/server/AlarmManagerService$Alarm;)V
...
.method public set(IJLandroid/app/PendingIntent;)V
    ...
    const-string v2, "in the set:type  triggerAtTime  operation="
...
.method public setRepeating(IJJLandroid/app/PendingIntent;)V
    ...
    const-string v2, "+++Alarm set:type="
    ...
    const-string v5, "+++Alarm set:type="
