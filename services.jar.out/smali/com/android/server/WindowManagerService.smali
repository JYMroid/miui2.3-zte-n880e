...
.field private mTestViewServer:Lcom/android/server/TestViewServer;
...
.method private constructor <init>(Landroid/content/Context;Lcom/android/server/PowerManagerService;Z)V
    ...
    iput-boolean v10, p0, Lcom/android/server/WindowManagerService;->mLayoutNeeded:Z
    ...
    iput-boolean v10, p0, Lcom/android/server/WindowManagerService;->mInTouchMode:Z
...
.method private final performLayoutAndPlaceSurfacesLockedInner(Z)V
    ...
    :cond_44
    invoke-virtual/range {v95 .. v95}, Lcom/android/server/WindowManagerService$WindowState;->getAttrs()Landroid/view/WindowManager$LayoutParams;
...
.method private updateFocusedWindowLocked(I)Z
    ...
    const-string v5, "updateFocusedWindowLocked newFocus="
...
.method public startTestViewServer(I)Z
    ...
    iget-object v1, p0, Lcom/android/server/WindowManagerService;->mTestViewServer:Lcom/android/server/TestViewServer;

    if-eqz v1, :cond_1

    iget-object v1, p0, Lcom/android/server/WindowManagerService;->mTestViewServer:Lcom/android/server/TestViewServer;

    invoke-virtual {v1}, Lcom/android/server/TestViewServer;->isRunning()Z
    ...
    invoke-virtual {v1}, Lcom/android/server/TestViewServer;->start()Z
    :try_end_0
    ...
    :cond_1
    :try_start_1
    new-instance v1, Lcom/android/server/TestViewServer;

    invoke-direct {v1, p0, p1}, Lcom/android/server/TestViewServer;-><init>(Lcom/android/server/WindowManagerService;I)V

    iput-object v1, p0, Lcom/android/server/WindowManagerService;->mTestViewServer:Lcom/android/server/TestViewServer;

    const-string v1, "TestViewServer"

    const-string v2, "View server start1"
