...
.method public getEasEnabled(Landroid/content/ComponentName;)Z
    .locals 6
    .parameter "who"
    ...
    iget v3, v1, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->easEnabled:I
...
.method public getMinComplexCharacters(Landroid/content/ComponentName;)I
    .locals 5
    .parameter "who"
    ...
    iget v4, v1, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->minimumComplexCharacters:I
    ...
    iget v3, v1, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->minimumComplexCharacters:I
...
.method public getPasswordAgingPeriod(Landroid/content/ComponentName;)J
    .locals 9
    .parameter "who"
    ...
    iget-wide v5, v1, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->agingPeriod:J
    ...
    iget-wide v3, v1, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->agingPeriod:J
...
.method public getPasswordNonRecurring(Landroid/content/ComponentName;)I
    .locals 5
    .parameter "who"
    ...
    iget v4, v1, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->nonRecurringPasswords:I
    ...
    iget v3, v1, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->nonRecurringPasswords:I
...
.method public getValidatePassword(Landroid/content/ComponentName;)Z
    .locals 6
    .parameter "who"
    ...
    iget v3, v1, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->validatePassword:I
...
.method public reportFailedPasswordAttempt()V
    ...
    .end local v0           #externalStorage:Z
    :cond_0
    :goto_0
    ...
    .restart local v0       #externalStorage:Z
    :cond_1
    const/4 v4, 0x0
...
.method public setEasEnabled(Landroid/content/ComponentName;Z)V
    .locals 5
    .parameter "who"
    .parameter "enable"
    ...
    iget v2, v0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->easEnabled:I
    ...
    :goto_1
    iput v2, v0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->easEnabled:I
...
.method public setMinComplexCharacters(Landroid/content/ComponentName;I)V
    .locals 3
    .parameter "who"
    .parameter "num"
    ...
    .local v0, ap:Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;
    iget v1, v0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->minimumComplexCharacters:I

    if-eq v1, p2, :cond_1

    iput p2, v0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->minimumComplexCharacters:I
...
.method public setPasswordAgingPeriod(Landroid/content/ComponentName;J)V
    .locals 3
    .parameter "who"
    .parameter "period"
    ...
    .local v0, ap:Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;
    iget-wide v1, v0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->agingPeriod:J

    cmp-long v1, v1, p2

    if-eqz v1, :cond_1

    iput-wide p2, v0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->agingPeriod:J
...
.method public setPasswordNonRecurring(Landroid/content/ComponentName;I)V
    .locals 3
    .parameter "who"
    .parameter "num"
    ...
    .local v0, ap:Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;
    iget v1, v0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->nonRecurringPasswords:I

    if-eq v1, p2, :cond_1

    iput p2, v0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->nonRecurringPasswords:I
...
.method public setValidatePassword(Landroid/content/ComponentName;Z)V
    .locals 5
    .parameter "who"
    .parameter "enable"
    ...
    .local v0, ap:Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;
    iget v2, v0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->validatePassword:I
    ...
    :goto_1
    iput v2, v0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->validatePassword:I
