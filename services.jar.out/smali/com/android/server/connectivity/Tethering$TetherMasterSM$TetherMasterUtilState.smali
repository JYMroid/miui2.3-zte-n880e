...
# virtual methods
.method protected addV6UpstreamInterface(Ljava/lang/String;)V
    .locals 7
    .parameter "iface"
    ...
    const-string v4, "Unexpected error! service is null"
...
.method protected chooseUpstreamType(Z)V
    ...
    invoke-static {v7, v8}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$2902(Lcom/android/server/connectivity/Tethering$TetherMasterSM;Z)Z
    ...
    invoke-static {v8}, Lcom/android/server/connectivity/Tethering;->access$2800(Lcom/android/server/connectivity/Tethering;)Z
    ...
    invoke-virtual {v4}, Landroid/net/NetworkInfo;->getIpv6Interface()Ljava/lang/String;

    move-result-object v7

    invoke-virtual {p0, v7}, Lcom/android/server/connectivity/Tethering$TetherMasterSM$TetherMasterUtilState;->addV6UpstreamInterface(Ljava/lang/String;)V
    ...
    const-string v9, "zhp setting dun ifacename ="
    ...
    const-string v7, "zhp TRY_TO_SETUP_MOBILE_CONNECTION"
    ...
    .local v6, mPhoneService:Lcom/android/internal/telephony/ITelephony;
    invoke-virtual {v4}, Landroid/net/NetworkInfo;->isConnected()Z
    ...
    invoke-interface {v6, v7}, Lcom/android/internal/telephony/ITelephony;->apnTypeAvailable(Ljava/lang/String;)Z
    ...
    .end local v4           #info:Landroid/net/NetworkInfo;
    .end local v6           #mPhoneService:Lcom/android/internal/telephony/ITelephony;
    :cond_5
    const-string v7, "Tethering"

    const-string v8, "checking if hipri brought us this connection"
    ...
    .local v5, infohp:Landroid/net/NetworkInfo;
    invoke-virtual {v4}, Landroid/net/NetworkInfo;->isIpv6Connected()Z
    ...
    const-string v8, "zhp i1 yes - hipri in use"
    ...
    .end local v4           #info:Landroid/net/NetworkInfo;
    .end local v5           #infohp:Landroid/net/NetworkInfo;
    :catch_0
    move-exception v7
    ...
    .restart local v4       #info:Landroid/net/NetworkInfo;
    .restart local v5       #infohp:Landroid/net/NetworkInfo;
    :cond_7
    :try_start_2
    invoke-virtual {v5}, Landroid/net/NetworkInfo;->isIpv6Connected()Z

    move-result v7

    if-eqz v7, :cond_6

    invoke-virtual {v5}, Landroid/net/NetworkInfo;->getIpv6Interface()Ljava/lang/String;
...
.method protected removeV6UpstreamInterface(Ljava/lang/String;)V
    .locals 7
    .parameter "iface"
...
.method protected turnOnMasterTetherSettings()Z
    ...
    :try_start_0
    invoke-interface {v4, v6}, Landroid/os/INetworkManagementService;->setIpForwardingEnabled(Z)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v7, "192.168.42.254"
    ...
    .local v1, dhcpPara:[Ljava/lang/String;
    ...
    invoke-static {v6}, Lcom/android/server/connectivity/Tethering;->access$3200(Lcom/android/server/connectivity/Tethering;)Landroid/content/Context;
    ...
    iget-object v7, v5, Landroid/net/wifi/WifiConfiguration;->ap_DhcpIPStart:Ljava/lang/String;

    aput-object v7, v1, v6

    const/4 v6, 0x3

    iget-object v7, v5, Landroid/net/wifi/WifiConfiguration;->ap_DhcpIPEnd:Ljava/lang/String;

    aput-object v7, v1, v6

    const/4 v6, 0x4

    iget-object v7, v5, Landroid/net/wifi/WifiConfiguration;->ap_DhcpLeaseTime:Ljava/lang/String;

    aput-object v7, v1, v6

    const/4 v6, 0x5

    iget-object v7, v5, Landroid/net/wifi/WifiConfiguration;->ap_DhcpEnable:Ljava/lang/String;
    ...
    const-string v8, "service.startTethering="
    ...
    invoke-interface {v4, v6}, Landroid/os/INetworkManagementService;->setDnsForwarders([Ljava/lang/String;)V
    :try_end_2
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_2} :catch_2

    move v6, v10

    .end local v1           #dhcpPara:[Ljava/lang/String;
    ...
    invoke-static {v7}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$3000(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)Lcom/android/internal/util/HierarchicalState;

    move-result-object v7

    #calls: Lcom/android/server/connectivity/Tethering$TetherMasterSM;->transitionTo(Lcom/android/internal/util/HierarchicalState;)V
    invoke-static {v6, v7}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$3100(Lcom/android/server/connectivity/Tethering$TetherMasterSM;Lcom/android/internal/util/HierarchicalState;)V
    ...
    .end local v2           #e:Ljava/lang/Exception;
    .restart local v1       #dhcpPara:[Ljava/lang/String;
...
.method protected turnOnMobileConnection()I
    ...
    const-string v3, "turnOnMobileConnection"
    ...
    const-string v3, "CMD_CELL_CONNECTION_RENEW start send!"
