...
.method public addDstRoute(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .local v4, ipver:Ljava/lang/String;
    :goto_0
    if-eqz p3, :cond_0
    ...
    :cond_0
    const-string v10, "route add dst %s %s %s"
    ...
    invoke-virtual {v10, v2}, Lcom/android/server/NativeDaemonConnector;->doCommand(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    .local v8, rsp:Ljava/lang/String;
    const-string v10, " "
    ...
    .end local v3           #code:I
    .end local v4           #ipver:Ljava/lang/String;
    .end local v8           #rsp:Ljava/lang/String;
    ...
    .restart local v4       #ipver:Ljava/lang/String;
    :cond_2
    const-string v10, "route add dst %s %s %s %s"
    ...
    .restart local v8       #rsp:Ljava/lang/String;
    ...
    const-string v11, "Error parsing code %s"
    ...
    const-string v11, "Null pointer exception while trying to add dst route, check ipAddr"
    ...
    .local v5, nde:Lcom/android/server/NativeDaemonConnectorException;
    const-string v10, "NetworkManagementService"

    const-string v11, "Failed to add dst route %s: for iface [%s] ip [%s]"
...
.method public addUpstreamV6Interface(Ljava/lang/String;)V
    ...
    const-string v2, "addUpstreamInterface("
...
.method public delDstRoute(Ljava/lang/String;)Z
    ...
    :goto_0
    const-string v8, "route del dst %s %s"
    ...
    .restart local v2       #ipver:Ljava/lang/String;
    ...
    const-string v9, "Null pointer exception while trying to del dst route, check ipAddr"
    ...
    .local v3, nde:Lcom/android/server/NativeDaemonConnectorException;
    const-string v8, "NetworkManagementService"

    const-string v9, "Failed to del dst route %s: for ip [%s]"
...
.method public delV4SrcRoute(I)Z
    ...
    :try_start_0
    const-string v6, "route del src v4 %d"
    ...
    const-string v6, "Failed to del src route %s: for rid [%d]"
...
.method public delV6SrcRoute(I)Z
    ...
    :try_start_0
    const-string v6, "route del src v6 %d"
...
.method public getIpForwardingEnabled()Z
    ...
    const-string v7, "Malformed response from native daemon: "
...
.method public removeUpstreamV6Interface(Ljava/lang/String;)V
    ...
    const-string v2, "removeUpstreamInterface("
...
.method public replaceV6DefaultRoute(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :cond_0
    const-string v7, "route replace def v6 %s"
    ...
    :cond_1
    const-string v7, "route replace def v6 %s %s"
...
.method public setAccessPoint(Landroid/net/wifi/WifiConfiguration;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v3, " %s %s %s %d %d %d %s %s"
    ...
    iget v5, p1, Landroid/net/wifi/WifiConfiguration;->ap_ChannelNum:I
    ...
    iget v5, p1, Landroid/net/wifi/WifiConfiguration;->ap_Preamble:I
    ...
    iget v5, p1, Landroid/net/wifi/WifiConfiguration;->ap_MaxClients:I
    ...
    iget-boolean v5, p1, Landroid/net/wifi/WifiConfiguration;->ap_hideSSID:Z
    ...
    iget-object v5, p1, Landroid/net/wifi/WifiConfiguration;->ap_MacFilter:Ljava/lang/String;
...
.method public setInterfaceThrottle(Ljava/lang/String;II)V
    ...
    const-string v1, "Error communicating with native daemon to set throttle"
