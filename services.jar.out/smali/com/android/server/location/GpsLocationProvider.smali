...
.field private static final NTP_INTERVAL:J = 0x2932e00L
...
.method static synthetic access$2472(Lcom/android/server/location/GpsLocationProvider;I)I
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2510(Lcom/android/server/location/GpsLocationProvider;)I
    .locals 2
    .parameter "x0"
...
.method static synthetic access$2702(Lcom/android/server/location/GpsLocationProvider;Landroid/os/Handler;)Landroid/os/Handler;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private getAGpsConnectionInfo(I)Lcom/android/server/location/GpsLocationProvider$AGpsConnectionInfo;
    ...
    new-instance v1, Lcom/android/server/location/GpsLocationProvider$AGpsConnectionInfo;

    invoke-direct {v1, p0, v2, v4}, Lcom/android/server/location/GpsLocationProvider$AGpsConnectionInfo;-><init>(Lcom/android/server/location/GpsLocationProvider;ILcom/android/server/location/GpsLocationProvider$1;)V
...
.method private handleUpdateNetworkState(ILandroid/net/NetworkInfo;)V
    ...
    .local v6, default_apn:Ljava/lang/String;
    if-nez v6, :cond_0
    ...
    invoke-virtual/range {p2 .. p2}, Landroid/net/NetworkInfo;->getIpv4Apn()Ljava/lang/String;

    move-result-object v11

    .local v11, ipv4Apn:Ljava/lang/String;
    invoke-virtual/range {p2 .. p2}, Landroid/net/NetworkInfo;->getIpv6Apn()Ljava/lang/String;

    move-result-object v12

    .local v12, ipv6Apn:Ljava/lang/String;
    if-eqz v12, :cond_2
    ...
    invoke-direct {p0, v8, v0}, Lcom/android/server/location/GpsLocationProvider;->native_agps_data_conn_open(Ljava/lang/String;I)V
    ...
    .end local v6           #default_apn:Ljava/lang/String;
    ...
    .end local v11           #ipv4Apn:Ljava/lang/String;
    .end local v12           #ipv6Apn:Ljava/lang/String;
    :cond_4
    :goto_5
    iget-boolean v0, p0, Lcom/android/server/location/GpsLocationProvider;->mNetworkAvailable:Z
    ...
    .restart local v6       #default_apn:Ljava/lang/String;
    :cond_a
    const/4 v0, 0x3
    ...
    .restart local v11       #ipv4Apn:Ljava/lang/String;
    .restart local v12       #ipv6Apn:Ljava/lang/String;
    :cond_b
    if-eqz v11, :cond_c
...
.method private reportAGpsStatus(III[B)V
    ...
    invoke-static {v0}, Lcom/android/server/location/GpsLocationProvider$AGpsConnectionInfo;->access$1000(Lcom/android/server/location/GpsLocationProvider$AGpsConnectionInfo;)Ljava/lang/String;
    ...
    const-string v4, "agpsConnInfo.mIPv4Addr "
    ...
    const-string v3, "call requestRouteToHostAddress failed"
    ...
    const-string v3, "agpsConnInfo.mAPN not set when receiving Phone.APN_ALREADY_ACTIVE"
...
.method private reportLocation(IDDDFFFJ[B)V
    .locals 12
    .parameter "flags"
    .parameter "latitude"
    .parameter "longitude"
    ...
    invoke-virtual {v9, v10}, Landroid/location/Location;->setExtras(Landroid/os/Bundle;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private startNavigating(Z)V
    ...
    const-string v0, "/data/gpsone_cert/standalone.txt"

    invoke-direct {v8, v0}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    .local v8, StandaloneFile:Ljava/io/File;
    new-instance v7, Ljava/io/File;

    const-string v0, "/data/gpsone_cert/msb.txt"

    invoke-direct {v7, v0}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    .local v7, MsbFile:Ljava/io/File;
    new-instance v6, Ljava/io/File;

    const-string v0, "/data/gpsone_cert/msa.txt"

    invoke-direct {v6, v0}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    .local v6, MsaFile:Ljava/io/File;
    invoke-virtual {v8}, Ljava/io/File;->exists()Z

    move-result v11

    .local v11, bStandalone:Z
    ...
    const-string v1, "LPZ-GPSTEST:position mode is standalone"
    ...
    const-string v1, "LPZ-GPSTEST:position mode is MSB"
    ...
    const-string v1, "LPZ-GPSTEST:position mode is MSA"
    ...
    .end local v6           #MsaFile:Ljava/io/File;
    .end local v7           #MsbFile:Ljava/io/File;
    .end local v8           #StandaloneFile:Ljava/io/File;
    .end local v9           #bMsa:Z
    .end local v10           #bMsb:Z
    .end local v11           #bStandalone:Z
    :cond_4
    :goto_2
    return-void
    ...
    .restart local v6       #MsaFile:Ljava/io/File;
    .restart local v7       #MsbFile:Ljava/io/File;
    .restart local v8       #StandaloneFile:Ljava/io/File;
    .restart local v9       #bMsa:Z
    .restart local v10       #bMsb:Z
    .restart local v11       #bStandalone:Z
    :cond_6
    const/16 v0, 0x3e8
