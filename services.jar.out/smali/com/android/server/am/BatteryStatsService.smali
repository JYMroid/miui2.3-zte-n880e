...
.method public noteBluetoothOff()V
    ...
    invoke-virtual {v3}, Lcom/android/internal/os/BatteryStatsImpl;->noteBluetoothOffLocked()V

    iget-object v3, p0, Lcom/android/server/am/BatteryStatsService;->mStats:Lcom/android/internal/os/BatteryStatsImpl;

    invoke-virtual {v3}, Lcom/android/internal/os/BatteryStatsImpl;->getBtHeadset()Landroid/bluetooth/BluetoothHeadset;
    ...
    invoke-virtual {v3, v4}, Lcom/android/internal/os/BatteryStatsImpl;->setBtHeadset(Landroid/bluetooth/BluetoothHeadset;)V

    monitor-exit v2
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v2, p0, Lcom/android/server/am/BatteryStatsService;->mHeadset:Landroid/bluetooth/BluetoothHeadset;
    ...
    :cond_0
    :goto_0
    iput-object v5, p0, Lcom/android/server/am/BatteryStatsService;->mHeadset:Landroid/bluetooth/BluetoothHeadset;
    ...
    const-string v3, "Unable to close BluetoothHeadset"
...
.method public noteBluetoothOn()V
    ...
    invoke-direct {v0, v2, v3}, Landroid/bluetooth/BluetoothHeadset;-><init>(Landroid/content/Context;Landroid/bluetooth/BluetoothHeadset$ServiceListener;)V
    ...
    invoke-virtual {v3, v0}, Lcom/android/internal/os/BatteryStatsImpl;->setBtHeadset(Landroid/bluetooth/BluetoothHeadset;)V
    ...
    :cond_0
    :goto_0
    iput-object v0, p0, Lcom/android/server/am/BatteryStatsService;->mHeadset:Landroid/bluetooth/BluetoothHeadset;
