...
.field minimumComplexCharacters:I

.field minimumPasswordLength:I

.field nonRecurringPasswords:I

.field passwordQuality:I

.field validatePassword:I
...
.method constructor <init>(Landroid/app/admin/DeviceAdminInfo;)V
    ...
    iput-wide v0, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->agingPeriod:J

    iput v2, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->nonRecurringPasswords:I

    iput v2, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->minimumComplexCharacters:I

    iput v2, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->validatePassword:I

    iput v2, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->easEnabled:I
...
.method readFromXml(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    iput-wide v3, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->agingPeriod:J

    goto :goto_1

    :cond_7
    const-string v3, "non-recurring-password"
    ...
    iput v3, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->nonRecurringPasswords:I

    goto/16 :goto_1

    :cond_8
    const-string v3, "min-complex-char"
    ...
    iput v3, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->minimumComplexCharacters:I

    goto/16 :goto_1

    :cond_9
    const-string v3, "validate-password"
    ...
    iput v3, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->validatePassword:I

    goto/16 :goto_1

    :cond_a
    const-string v3, "eas-enabled"
    ...
    iput v3, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->easEnabled:I
...
.method writeToXml(Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    const-string v8, "eas-enabled"

    const-string v7, "aging-period"
    ...
    :cond_2
    iget-wide v0, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->agingPeriod:J
    ...
    :cond_3
    iget v0, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->nonRecurringPasswords:I

    if-eq v0, v6, :cond_4

    const-string v0, "non-recurring-password"
    ...
    :cond_4
    iget v0, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->minimumComplexCharacters:I

    if-eq v0, v6, :cond_5

    const-string v0, "min-complex-char"
    ...
    :cond_5
    iget v0, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->validatePassword:I

    if-eq v0, v6, :cond_6

    const-string v0, "validate-password"
    ...
    :cond_6
    iget v0, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->easEnabled:I

    if-eq v0, v6, :cond_7

    const-string v0, "eas-enabled"
