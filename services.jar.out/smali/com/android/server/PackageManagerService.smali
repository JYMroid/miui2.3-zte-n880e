...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iget-boolean v0, v0, Lcom/android/server/PackageManagerService;->mRestoredSettings:Z
    ...
    const-string v6, "There is first boot. And I can init default launcher homescreen!!"

    invoke-static {v5, v6}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    invoke-direct/range {p0 .. p0}, Lcom/android/server/PackageManagerService;->setDefaultHomeScreenLauncher()Z
...
.method private final getDefaultHomeScreenName()Landroid/content/ComponentName;
    ...
    invoke-direct {p0, v3, v8, v9}, Lcom/android/server/PackageManagerService;->findElementByValue(Lorg/w3c/dom/Document;Ljava/lang/String;Ljava/lang/String;)Lorg/w3c/dom/Element;
    ...
    invoke-direct {p0, v5, v8, v9}, Lcom/android/server/PackageManagerService;->findValueByTag(Lorg/w3c/dom/Element;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v8, "etc/customize/default_homescreen.xml is not found. Please check the build prop!"
    ...
    const-string v8, "configuration parser error."
...
.method private scanPackageLI(Landroid/content/pm/PackageParser$Package;IIJ)Landroid/content/pm/PackageParser$Package;
    ...
    :goto_2d
    iput-boolean v6, v5, Landroid/content/pm/ApplicationInfo;->isImportantApp:Z
    ...
    const-string v7, "tcd find important process= "
    ...
    iget-boolean v7, v7, Landroid/content/pm/ApplicationInfo;->isImportantApp:Z
...
.method private scanPackageLI(Ljava/io/File;IIJ)Landroid/content/pm/PackageParser$Package;
    ...
    const-string v7, "com.eshore.ezone"
    ...
    const-string v7, "com.sohu.newsclient"
    ...
    const-string v7, "cn.goapk.market"
    ...
    const-string v7, "com.zhadui.stream"

    if-ne v5, v7, :cond_5

    :cond_1
    iget-object v5, v8, Landroid/content/pm/PackageParser$Package;->applicationInfo:Landroid/content/pm/ApplicationInfo;

    const/4 v7, 0x0

    iput-boolean v7, v5, Landroid/content/pm/ApplicationInfo;->svc_autostart:Z
...
.method private setDefaultHomeScreenLauncher()Z
    ...
    .local v12, homescreenIntent:Landroid/content/Intent;
    ...
    .local v11, homeList:Ljava/util/List;,"Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    const/4 v6, 0x0
    ...
    .local v5, activityList:Ljava/util/List;,"Ljava/util/List<Landroid/content/pm/ActivityInfo;>;"
    const/4 v13, 0x0
    ...
    const-string v18, "There is less than one Homescreen in the phone!"

    invoke-static/range {v17 .. v18}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    const/16 v17, 0x0

    .end local v5           #activityList:Ljava/util/List;,"Ljava/util/List<Landroid/content/pm/ActivityInfo;>;"
    .end local v6           #count:I
    .end local v11           #homeList:Ljava/util/List;,"Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    .end local v13           #i:I
    :goto_1
    return v17

    .restart local v5       #activityList:Ljava/util/List;,"Ljava/util/List<Landroid/content/pm/ActivityInfo;>;"
    .restart local v6       #count:I
    .restart local v11       #homeList:Ljava/util/List;,"Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    .restart local v13       #i:I
    :cond_2
    invoke-direct/range {p0 .. p0}, Lcom/android/server/PackageManagerService;->getDefaultHomeScreenName()Landroid/content/ComponentName;

    move-result-object v7

    .local v7, defaultLauncher:Landroid/content/ComponentName;
    if-nez v7, :cond_3

    const-string v17, "PackageManager"

    const-string v18, "Can not find default homescreen custom!"
    ...
    .local v10, hasDefaultlauncher:Z
    move v0, v6
    ...
    const-string v18, "Default launcher is not in the phone!"
    ...
    #getter for: Lcom/android/server/PackageManagerService$Settings;->mPreferredActivities:Lcom/android/server/IntentResolver;
    invoke-static/range {v18 .. v18}, Lcom/android/server/PackageManagerService$Settings;->access$1200(Lcom/android/server/PackageManagerService$Settings;)Lcom/android/server/IntentResolver;

    move-result-object v18

    new-instance v19, Lcom/android/server/PackageManagerService$PreferredActivity;
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lcom/android/server/PackageManagerService$PreferredActivity;-><init>(Landroid/content/IntentFilter;I[Landroid/content/ComponentName;Landroid/content/ComponentName;)V

    invoke-virtual/range {v18 .. v19}, Lcom/android/server/IntentResolver;->addFilter(Landroid/content/IntentFilter;)V
    ...
    .end local v5           #activityList:Ljava/util/List;,"Ljava/util/List<Landroid/content/pm/ActivityInfo;>;"
    .end local v6           #count:I
    .end local v7           #defaultLauncher:Landroid/content/ComponentName;
    .end local v9           #filter:Landroid/content/IntentFilter;
    .end local v10           #hasDefaultlauncher:Z
    .end local v11           #homeList:Ljava/util/List;,"Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    .end local v13           #i:I
    ...
    const-string v18, "setDefaultHomeScreenLauncher error:"
    ...
    const-string v18, "There is less than one HomeIntent receiver in the phone!"
...
.method private updateExternalMediaStatusInner(ZZ)V
    ...
    .local v24, removeCids:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    new-instance v22, Ljava/util/HashMap;

    invoke-direct/range {v22 .. v22}, Ljava/util/HashMap;-><init>()V

    .local v22, processCids:Ljava/util/HashMap;,"Ljava/util/HashMap<Lcom/android/server/PackageManagerService$SdInstallArgs;Ljava/lang/String;>;"
    invoke-static {}, Lcom/android/internal/content/PackageHelper;->getSecureContainerList()[Ljava/lang/String;
    ...
    const-string v26, "/pkg.apk"

    .local v26, suffix:Ljava/lang/String;
    ...
    .local v11, i:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/content/pm/PackageParser$Package;>;"
    :cond_1
    :goto_0
    invoke-interface {v11}, Ljava/util/Iterator;->hasNext()Z
    ...
    const-string v33, "apps number on SD card is "
    ...
    .restart local v19       #p:Landroid/content/pm/PackageParser$Package;
    move-object/from16 v0, v19
    ...
    .end local v16           #listNum:I
    .restart local v15       #listNum:I
    :try_start_2
    ...
    .end local v11           #i:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/content/pm/PackageParser$Package;>;"
    .end local v15           #listNum:I
    .end local v21           #prefix:Ljava/lang/String;
    .end local v26           #suffix:Ljava/lang/String;
    :cond_5
    if-eqz v14, :cond_6
    ...
    const-string v31, "No secure containers on sdcard"
    ...
    .restart local v26       #suffix:Ljava/lang/String;
    :catchall_0
    move-exception v31
    ...
    #getter for: Lcom/android/server/PackageManagerService$Settings;->mPackages:Ljava/util/HashMap;
    invoke-static/range {v31 .. v31}, Lcom/android/server/PackageManagerService$Settings;->access$400(Lcom/android/server/PackageManagerService$Settings;)Ljava/util/HashMap;
    ...
    .end local v17           #num:I
    .end local v29           #uidList:[I
    .restart local v11       #i:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/content/pm/PackageParser$Package;>;"
    .restart local v16       #listNum:I
    .restart local v21       #prefix:Ljava/lang/String;
    .restart local v26       #suffix:Ljava/lang/String;
    :catchall_3
