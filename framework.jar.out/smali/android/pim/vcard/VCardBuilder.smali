...
.method private appendPhoneticNameFields(Landroid/content/ContentValues;)V
    ...
    iget-boolean v11, p0, Landroid/pim/vcard/VCardBuilder;->mNeedsToConvertPhoneticString:Z

    if-eqz v11, :cond_1

    invoke-static {v8}, Landroid/pim/vcard/VCardUtils;->toHalfWidthString(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v11, p0, Landroid/pim/vcard/VCardBuilder;->mBuilder:Ljava/lang/StringBuilder;
    ...
    :cond_2
    iget v11, p0, Landroid/pim/vcard/VCardBuilder;->mVCardType:I

    invoke-static {v11}, Landroid/pim/vcard/VCardConfig;->isVersion40(I)Z
    ...
    iget-boolean v11, p0, Landroid/pim/vcard/VCardBuilder;->mUsesDefactProperty:Z
    ...
    iget-boolean v11, p0, Landroid/pim/vcard/VCardBuilder;->mShouldUseQuotedPrintable:Z
    ...
    invoke-static {v11}, Landroid/pim/vcard/VCardUtils;->containsOnlyNonCrLfPrintableAscii([Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v11}, Landroid/pim/vcard/VCardBuilder;->shouldAppendCharsetParam([Ljava/lang/String;)Z
    ...
    iget-object v12, p0, Landroid/pim/vcard/VCardBuilder;->mVCardCharsetParameter:Ljava/lang/String;
    ...
    invoke-static {v11}, Landroid/pim/vcard/VCardConfig;->isVersion30(I)Z
    ...
    invoke-static {v11, v3, v5, v4}, Landroid/pim/vcard/VCardUtils;->constructNameFromElements(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v7}, Landroid/pim/vcard/VCardBuilder;->escapeCharacters(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_e
    iget-boolean v11, p0, Landroid/pim/vcard/VCardBuilder;->mIsJapaneseMobilePhone:Z
    ...
    iget-boolean v11, p0, Landroid/pim/vcard/VCardBuilder;->mRefrainsQPToNameProperties:Z
...
.method public appendEmptyEntry()Landroid/pim/vcard/VCardBuilder;
    .locals 6
    ...
    iget-boolean v0, p0, Landroid/pim/vcard/VCardBuilder;->mIsJapaneseMobilePhone:Z
...
.method public appendEvents(Ljava/util/List;)Landroid/pim/vcard/VCardBuilder;
    ...
    invoke-virtual {v11, v0}, Landroid/text/format/Time;->parse(Ljava/lang/String;)Z
    ...
    :cond_5
    invoke-virtual {v11, v0}, Landroid/text/format/Time;->parse3339(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v12, v1}, Landroid/pim/vcard/VCardBuilder;->appendAndroidSpecificProperty(Ljava/lang/String;Landroid/content/ContentValues;)V
...
.method public appendPhones(Ljava/util/List;)Landroid/pim/vcard/VCardBuilder;
    ...
    .local v15, phoneSet:Ljava/util/Set;,"Ljava/util/Set<Ljava/lang/String;>;"
    invoke-interface/range {p1 .. p1}, Ljava/util/List;->iterator()Ljava/util/Iterator;
    ...
    .local v17, typeAsObject:Ljava/lang/Integer;
    ...
    .local v10, isPrimaryAsInteger:Ljava/lang/Integer;
    if-eqz v10, :cond_4
    ...
    invoke-static/range {v18 .. v18}, Landroid/pim/vcard/VCardConfig;->refrainPhoneNumberFormatting(I)Z
    ...
    :cond_6
    invoke-static {v13}, Landroid/pim/vcard/VCardUtils;->splitAndFormatPhoneNumbers4VcardExport(Ljava/lang/String;)Ljava/util/List;

    move-result-object v14

    .local v14, phoneNumberList:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    ...
    .end local v9           #isPrimary:Z
    .end local v10           #isPrimaryAsInteger:Ljava/lang/Integer;
    .end local v11           #label:Ljava/lang/String;
    .end local v13           #phoneNumber:Ljava/lang/String;
    .end local v14           #phoneNumberList:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    .end local v15           #phoneSet:Ljava/util/Set;,"Ljava/util/Set<Ljava/lang/String;>;"
    .end local v16           #type:I
    .end local v17           #typeAsObject:Ljava/lang/Integer;
    :cond_8
    if-nez v12, :cond_9
