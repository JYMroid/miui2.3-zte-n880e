...
.method public static unescapeText(Ljava/lang/String;)Ljava/lang/String;
    ...
    .local v4, next_ch:C
    invoke-static {v4}, Landroid/pim/vcard/VCardParserImpl_V21;->unescapeCharacter(C)Ljava/lang/String;
...
.method protected handleEncoding(Ljava/lang/String;)V
    ...
    invoke-interface {v0, v1}, Landroid/pim/vcard/VCardInterpreter;->propertyParamValue(Ljava/lang/String;)V
...
.method protected maybeUnescapeText(Ljava/lang/String;)Ljava/lang/String;
    ...
    .prologue
    invoke-static {p1}, Landroid/pim/vcard/VCardParserImpl_V21;->unescapeText(Ljava/lang/String;)Ljava/lang/String;
...
.method protected parseItems()V
    ...
    .catch Landroid/pim/vcard/exception/VCardException; {:try_start_0 .. :try_end_0} :catch_1
    ...
    const-string v8, "Invalid line which looks like some comment was found. Ignored."
    ...
    .local v6, e:Landroid/pim/vcard/exception/VCardException;
    const-string v8, "VCardParserImpl_V21"

    const-string v8, "Invalid line which looks like some improper line ignored"
    ...
    .end local v6           #e:Landroid/pim/vcard/exception/VCardException;
    :cond_1
    return-void
.end method
...
.method protected separateLineAndHandleGroup(Ljava/lang/String;)[Ljava/lang/String;
    ...
    new-instance v9, Landroid/pim/vcard/exception/VCardInvalidCommentLineException;

    invoke-direct {v9}, Landroid/pim/vcard/exception/VCardInvalidCommentLineException;-><init>()V
    ...
    invoke-virtual {p0, v9}, Landroid/pim/vcard/VCardParserImpl_V21;->maybeUnescapeText(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_2
    iget-object v9, p0, Landroid/pim/vcard/VCardParserImpl_V21;->mInterpreter:Landroid/pim/vcard/VCardInterpreter;

    invoke-interface {v9, v6}, Landroid/pim/vcard/VCardInterpreter;->propertyName(Ljava/lang/String;)V
    ...
    invoke-interface {v9, v1}, Landroid/pim/vcard/VCardInterpreter;->propertyGroup(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v9}, Landroid/pim/vcard/VCardParserImpl_V21;->handleParams(Ljava/lang/String;)V
    ...
    .end local v0           #ch:C
    :cond_10
    new-instance v9, Landroid/pim/vcard/exception/VCardInvalidLineException;
    ...
    invoke-direct {v9, v10}, Landroid/pim/vcard/exception/VCardInvalidLineException;-><init>(Ljava/lang/String;)V
