...
.method private addPhone(ILjava/lang/String;Ljava/lang/String;Z)V
    ...
    .prologue
    iget-object v4, p0, Landroid/pim/vcard/VCardEntry;->mPhoneList:Ljava/util/List;
    ...
    iput-object v4, p0, Landroid/pim/vcard/VCardEntry;->mPhoneList:Ljava/util/List;
    ...
    invoke-static {v4}, Landroid/pim/vcard/VCardConfig;->refrainPhoneNumberFormatting(I)Z
    ...
    :goto_0
    new-instance v2, Landroid/pim/vcard/VCardEntry$PhoneData;

    invoke-direct {v2, p1, v1, p3, p4}, Landroid/pim/vcard/VCardEntry$PhoneData;-><init>(ILjava/lang/String;Ljava/lang/String;Z)V

    .local v2, phoneData:Landroid/pim/vcard/VCardEntry$PhoneData;
    iget-object v4, p0, Landroid/pim/vcard/VCardEntry;->mPhoneList:Ljava/util/List;
    ...
    .end local v2           #phoneData:Landroid/pim/vcard/VCardEntry$PhoneData;
    :cond_2
    invoke-static {v3}, Landroid/pim/vcard/VCardUtils;->formatPhoneNumber4VcardImport(Ljava/lang/String;)Ljava/lang/String;
...
.method private handlePhoneticNameFromSound(Ljava/util/List;)V
    ...
    iget-object v1, p0, Landroid/pim/vcard/VCardEntry;->mPhoneticMiddleName:Ljava/lang/String;
    ...
    iget-object v1, p0, Landroid/pim/vcard/VCardEntry;->mPhoneticGivenName:Ljava/lang/String;
    ...
    iput-object v1, p0, Landroid/pim/vcard/VCardEntry;->mPhoneticFamilyName:Ljava/lang/String;
    ...
    iput-object v1, p0, Landroid/pim/vcard/VCardEntry;->mPhoneticMiddleName:Ljava/lang/String;
    ...
    iput-object v1, p0, Landroid/pim/vcard/VCardEntry;->mPhoneticGivenName:Ljava/lang/String;
...
.method public addProperty(Landroid/pim/vcard/VCardEntry$Property;)V
    ...
    .local v19, propValueList:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    ...
    .end local v20           #typeCollection:Ljava/util/Collection;,"Ljava/util/Collection<Ljava/lang/String;>;"
    .end local v25           #valuesAreAllEmpty:Z
    :cond_13
...
.method public pushIntoContentResolver(Landroid/content/ContentResolver;)Landroid/net/Uri;
    ...
    iget-object v3, v14, Landroid/pim/vcard/VCardEntry$EmailData;->data:Ljava/lang/String;
