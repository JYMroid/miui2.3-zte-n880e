...
.field private static final GATT_INTENT_DELAY:I = 0x1770
...
.field private static final MESSAGE_AVRCP_PASS_THROUGH_TIMEOUT:I = 0xb

.field private static final MESSAGE_BT_BOOTUP:I = 0xa

.field private static final MESSAGE_DISCOVERABLE_CHANGE_TIMEOUT:I = 0xd

.field private static final MESSAGE_DISCOVERABLE_TIMEOUT:I = 0x4

.field private static final MESSAGE_FINISH_DISABLE:I = 0x2

.field private static final MESSAGE_GATT_CHARACTERISTICS_DISCOVERY:I = 0x8

.field private static final MESSAGE_GATT_INTENT:I = 0x7

.field private static final MESSAGE_PROFILE_DISCONNECT_TIMEOUT:I = 0xc

.field private static final MESSAGE_REGISTER_SDP_RECORDS:I = 0x1

.field private static final MESSAGE_START_DUN_SERVER:I = 0x6

.field private static final MESSAGE_START_SAP_SERVER:I = 0x9
...
.field public static final SAP_ACCESS_ALLOWED_ACTION:Ljava/lang/String; = "com.android.bluetooth.sap.accessallowed"

.field public static final SAP_ACCESS_DISALLOWED_ACTION:Ljava/lang/String; = "com.android.bluetooth.sap.accessdisallowed"

.field public static final SAP_AUTHORIZE_INTENT:Ljava/lang/String; = "com.android.bluetooth.sap.accessrequest"

.field public static final SAP_EXTRA_ALWAYS_ALLOWED:Ljava/lang/String; = "com.android.bluetooth.sap.alwaysallowed"
...
.field private mFTPenable:Z

.field private final mGattIntentTracker:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v2, p0, Landroid/server/BluetoothService;->mDUNenable:Z

    iput-boolean v2, p0, Landroid/server/BluetoothService;->mSAPenable:Z

    iput-boolean v2, p0, Landroid/server/BluetoothService;->mFTPenable:Z
    ...
    iput-object v0, p0, Landroid/server/BluetoothService;->mGattProperties:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Landroid/server/BluetoothService;->mDeviceFeatureCache:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Landroid/server/BluetoothService;->mDeviceL2capPsmCache:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Landroid/server/BluetoothService;->mGattIntentTracker:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Landroid/server/BluetoothService;->mGattServiceTracker:Ljava/util/HashMap;
    ...
    invoke-direct {v0, v1, v3}, Landroid/bluetooth/BluetoothProfileState;-><init>(Landroid/content/Context;I)V
    ...
    invoke-direct {p0, v4, v0}, Landroid/server/BluetoothService;->_setScanMode(II)Z

    iput v4, p0, Landroid/server/BluetoothService;->prevScanMode:I
    ...
    iput-object v5, p0, Landroid/server/BluetoothService;->mLastRemoteAddress:Ljava/lang/String;

    iput-object v5, p0, Landroid/server/BluetoothService;->mLastRemoteName:Ljava/lang/String;
...
.method private declared-synchronized _setScanMode(II)Z
    ...
    invoke-direct {p0, v4, v5}, Landroid/server/BluetoothService;->setPropertyBoolean(Ljava/lang/String;Z)Z
    ...
    .local v2, msgd:Landroid/os/Message;
    iget-object v4, p0, Landroid/server/BluetoothService;->mHandler:Landroid/os/Handler;
    ...
    .end local v2           #msgd:Landroid/os/Message;
    :cond_1
    const-string v4, "BluetoothService"
...
.method static synthetic access$1008(Landroid/server/BluetoothService;)I
    .locals 2
    .parameter "x0"
...
.method static synthetic access$1010(Landroid/server/BluetoothService;)I
    .locals 2
    .parameter "x0"
...
.method static synthetic access$1500(Landroid/server/BluetoothService;Z)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$1602(Landroid/server/BluetoothService;Z)Z
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$1700(Landroid/server/BluetoothService;)Landroid/server/BluetoothService$BondState;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1800(Landroid/server/BluetoothService;)V
    .locals 0
    .parameter "x0"
...
.method static synthetic access$1900(Landroid/server/BluetoothService;)Z
    ...
    .prologue
    iget-boolean v0, p0, Landroid/server/BluetoothService;->mDUNenable:Z
...
.method static synthetic access$200(Landroid/server/BluetoothService;)Z
    ...
    .prologue
    iget-boolean v0, p0, Landroid/server/BluetoothService;->mSAPenable:Z
...
.method static synthetic access$3200(Landroid/server/BluetoothService;Ljava/lang/String;)Landroid/bluetooth/BluetoothDeviceProfileState;
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$3300(Landroid/server/BluetoothService;)Landroid/bluetooth/BluetoothAdapter;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$3500(Landroid/server/BluetoothService;II)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$3702(Landroid/server/BluetoothService;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$3800(Landroid/server/BluetoothService;)Landroid/server/BluetoothService$ConnectionManager;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$400(Landroid/server/BluetoothService;Z)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private declared-synchronized finishDisable(Z)V
    ...
    :cond_1
    :try_start_1
    iget-boolean v6, p0, Landroid/server/BluetoothService;->mDUNenable:Z

    if-ne v6, v8, :cond_2

    const-string v6, "BluetoothService"

    const-string v7, "Stopping BT-DUN server"

    invoke-static {v6, v7}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    const-string v6, "bt-dun"

    invoke-static {v6}, Landroid/os/SystemService;->stop(Ljava/lang/String;)V

    :cond_2
    iget-boolean v6, p0, Landroid/server/BluetoothService;->mSAPenable:Z

    if-ne v6, v8, :cond_3

    const-string v6, "BluetoothService"

    const-string v7, "Stopping BT SAP server"
...
.method private getCharacteristicsFromCache(Ljava/lang/String;)[Ljava/lang/String;
    ...
    const-string v3, "getCharacteristicsFromCache nothing found  for service "
    ...
    const-string v3, "getCharacteristicsFromCache found "
    ...
    const-string v3, " characteristics on service "
...
.method private getGattServicesFromCache(Ljava/lang/String;)[Ljava/lang/String;
    ...
    const-string v3, "getGattServicesFromCache: not services found"
...
.method private matchGattService(Landroid/server/BluetoothService$RemoteService;)[Ljava/lang/String;
    .locals 13
    .parameter "service"

    .prologue
    iget-object v10, p1, Landroid/server/BluetoothService$RemoteService;->address:Ljava/lang/String;

    const-string v11, "Services"

    invoke-virtual {p0, v10, v11}, Landroid/server/BluetoothService;->getRemoteDeviceProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v12, "matchGattService: No GATT based services were found on "

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget-object v12, p1, Landroid/server/BluetoothService$RemoteService;->address:Ljava/lang/String;
    ...
    .local v0, count:I
    iget-object v8, p1, Landroid/server/BluetoothService$RemoteService;->uuid:Landroid/os/ParcelUuid;
    ...
    const-string v12, "Requested GATT UUID to match: "
    ...
    invoke-virtual {p0, v10, v11}, Landroid/server/BluetoothService;->getGattServiceProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v12, "Found GATT UUID: "
    ...
    .restart local v6       #serviceUuid:Ljava/lang/String;
    :cond_3
    const/4 v3, 0x1
    ...
    const-string v12, " instances of service "
...
.method private declared-synchronized sendGattIntent(Landroid/server/BluetoothService$RemoteService;)V
    .locals 5
    .parameter "service"
    ...
    invoke-direct {p0, p1}, Landroid/server/BluetoothService;->matchGattService(Landroid/server/BluetoothService$RemoteService;)[Ljava/lang/String;

    move-result-object v0

    .local v0, gattPath:[Ljava/lang/String;
    const-string v2, "android.bluetooth.device.extra.DEVICE"

    iget-object v3, p0, Landroid/server/BluetoothService;->mAdapter:Landroid/bluetooth/BluetoothAdapter;

    iget-object v4, p1, Landroid/server/BluetoothService$RemoteService;->address:Ljava/lang/String;
    ...
    iget-object v3, p1, Landroid/server/BluetoothService$RemoteService;->uuid:Landroid/os/ParcelUuid;

    invoke-virtual {v1, v2, v3}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;

    const-string v2, "android.bluetooth.device.extra.GATT"
    ...
    iget-object v2, p0, Landroid/server/BluetoothService;->mGattIntentTracker:Ljava/util/ArrayList;
    ...
    .end local v0           #gattPath:[Ljava/lang/String;
...
.method public declared-synchronized createBond(Ljava/lang/String;)Z
    ...
    invoke-static {v0, p1}, Landroid/server/BluetoothService$BondState;->access$3400(Landroid/server/BluetoothService$BondState;Ljava/lang/String;)V
...
.method public declared-synchronized disable(Z)Z
    ...
    :pswitch_2
    iget-object v2, p0, Landroid/server/BluetoothService;->mEnableThread:Landroid/server/BluetoothService$EnableThread;

    if-eqz v2, :cond_0

    iget-object v2, p0, Landroid/server/BluetoothService;->mEnableThread:Landroid/server/BluetoothService$EnableThread;

    invoke-virtual {v2}, Landroid/server/BluetoothService$EnableThread;->isAlive()Z
    ...
    const-string v3, "Oops: disable BT when enable thread is still alive..."
    ...
    invoke-direct {p0, v2, v3}, Landroid/server/BluetoothService;->_setScanMode(II)Z
    ...
    invoke-direct {p0, v2}, Landroid/server/BluetoothService;->setBluetoothState(I)V
...
.method public declared-synchronized discoverCharacteristics(Ljava/lang/String;Landroid/bluetooth/IBluetoothGattService;)Z
    .locals 6
    .parameter "path"
    ...
    iget-object v2, p0, Landroid/server/BluetoothService;->mGattServiceTracker:Ljava/util/HashMap;
    ...
    const-string v4, "discoverCharacteristics: queuery is in already in progress for "
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string v22, "mIsAirplaneSensitive = "
    ...
    const-string v22, "mIsAirplaneToggleable = "
    ...
    const-string v22, "Local address = "
    ...
    const-string v22, "isDiscovering() = "
    ...
    .local v18, uuidChannels:Ljava/util/Map;,"Ljava/util/Map<Landroid/os/ParcelUuid;Ljava/lang/Integer;>;"
    if-nez v18, :cond_5

    const-string v21, "\tuuids = null"
    ...
    .local v19, uuidPsms:Ljava/util/Map;,"Ljava/util/Map<Landroid/os/ParcelUuid;Ljava/lang/Integer;>;"
    if-nez v19, :cond_7
    ...
    check-cast v16, Landroid/server/BluetoothService$RemoteService;

    .local v16, service:Landroid/server/BluetoothService$RemoteService;
    ...
    const-string v22, "\tPENDING CALLBACK: "
    ...
    .end local v16           #service:Landroid/server/BluetoothService$RemoteService;
    .end local v18           #uuidChannels:Ljava/util/Map;,"Ljava/util/Map<Landroid/os/ParcelUuid;Ljava/lang/Integer;>;"
    .end local v19           #uuidPsms:Ljava/util/Map;,"Ljava/util/Map<Landroid/os/ParcelUuid;Ljava/lang/Integer;>;"
    :pswitch_0
    const-string v21, "Bluetooth OFF\n"
    ...
    :pswitch_1
    const-string v21, "Bluetooth TURNING ON\n"
    ...
    :pswitch_2
    const-string v21, "Bluetooth TURNING OFF\n"
    ...
    .restart local v18       #uuidChannels:Ljava/util/Map;,"Ljava/util/Map<Landroid/os/ParcelUuid;Ljava/lang/Integer;>;"
    :cond_5
    ...
    const-string v22, " RFCOMM channel = "
    ...
    .restart local v19       #uuidPsms:Ljava/util/Map;,"Ljava/util/Map<Landroid/os/ParcelUuid;Ljava/lang/Integer;>;"
    :cond_7
    ...
    .restart local v17       #uuid:Landroid/os/ParcelUuid;
    ...
    .local v15, psm:Ljava/lang/Integer;
    if-nez v15, :cond_8
    ...
    .end local v5           #bondState:I
    .end local v12           #i$:Ljava/util/Iterator;
    .end local v15           #psm:Ljava/lang/Integer;
    .end local v17           #uuid:Landroid/os/ParcelUuid;
    .end local v18           #uuidChannels:Ljava/util/Map;,"Ljava/util/Map<Landroid/os/ParcelUuid;Ljava/lang/Integer;>;"
    .end local v19           #uuidPsms:Ljava/util/Map;,"Ljava/util/Map<Landroid/os/ParcelUuid;Ljava/lang/Integer;>;"
    :cond_9
    const-string v21, "Devices"
    ...
    const-string v22, "getBatteryUsageHint() = "
    ...
    :pswitch_4
    const-string v21, "getState() = STATE_DISCONNECTED"
    ...
    :pswitch_5
    const-string v21, "getState() = STATE_CONNECTING"
    ...
    :pswitch_6
    const-string v21, "getState() = STATE_CONNECTED"
    ...
    :pswitch_7
    const-string v21, "getState() = STATE_ERROR"
...
.method public declared-synchronized enable(Z)Z
    ...
    :cond_2
    const-string v8, "ro.qualcomm.bluetooth.sap"
    ...
    iput-boolean v8, p0, Landroid/server/BluetoothService;->mSAPenable:Z
...
.method public declared-synchronized getDeviceBlockedState(Ljava/lang/String;)Z
    ...
    const-string v3, "setDeviceBlockedState, Device not paired."
...
.method declared-synchronized getGattServiceProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    .locals 4
    .parameter "path"
    .parameter "property"
    ...
    const-string v2, "property present"
    ...
    const-string v3, "getGattProperty: "
...
.method public declared-synchronized getGattServices(Ljava/lang/String;Landroid/os/ParcelUuid;)Z
    ...
    iget-object v4, p0, Landroid/server/BluetoothService;->mGattIntentTracker:Ljava/util/ArrayList;
    ...
    const-string v5, "Get device property: Services"
    ...
    const-string v6, "No GATT based services were found on "
    ...
    const-string v6, "Need to Create Remote Device"
    ...
    const-string v6, " before accessing properties"
...
.method declared-synchronized getRemoteDeviceProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .prologue
    const-string v1, "getRemoteDeviceProperty: "
...
.method public getRemoteFeature(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    iget-object v1, p0, Landroid/server/BluetoothService;->mDeviceFeatureCache:Ljava/util/HashMap;
...
.method public getRemoteL2capPsm(Ljava/lang/String;Landroid/os/ParcelUuid;)I
    ...
    :cond_2
    iget-object v1, p0, Landroid/server/BluetoothService;->mDeviceL2capPsmCache:Ljava/util/HashMap;
...
.method declared-synchronized makeDiscoverCharacteristicsCallback(Ljava/lang/String;)V
    .locals 6
    .parameter "servicePath"
    ...
    :try_start_1
    invoke-interface {v0, v1}, Landroid/bluetooth/IBluetoothGattService;->onCharacteristicsDiscovered([Ljava/lang/String;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized registerCharacteristicsWatcher(Ljava/lang/String;)Z
    .locals 4
    .parameter "path"
...
.method public declared-synchronized sapAuthorize(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v1}, Landroid/server/BluetoothEventLoop;->getAuthorizationRequestData()Ljava/util/HashMap;
...
.method public declared-synchronized setDeviceBlockedState(Ljava/lang/String;I)V
    ...
    const-string v2, "setDeviceBlockedState("
    ...
    const-string v1, "setDeviceBlockedState, peer device is paired, call setDevicePropertyBooleanNative(...)."
    ...
    const-string v1, "setDeviceBlockedState, Device not paired."
...
.method updateDeviceServiceChannelCache(Ljava/lang/String;)V
    ...
    const-string v20, "Bluetooth is not on"

    invoke-static/range {v20 .. v20}, Landroid/server/BluetoothService;->log(Ljava/lang/String;)V
    ...
    const-string v21, "updateDeviceServiceChannelCache("
    ...
    .local v19, uuid:Landroid/os/ParcelUuid;
    move-object v0, v9
    ...
    invoke-virtual/range {v19 .. v19}, Landroid/os/ParcelUuid;->toString()Ljava/lang/String;
    ...
    invoke-static/range {v19 .. v19}, Landroid/bluetooth/BluetoothUuid;->isPrintingStatus(Landroid/os/ParcelUuid;)Z
    ...
    .end local v8           #channel:I
    :cond_4
    invoke-static/range {v19 .. v19}, Landroid/bluetooth/BluetoothUuid;->isDirectPrinting(Landroid/os/ParcelUuid;)Z
    ...
    .local v4, SupportedFormats:Ljava/lang/String;
    new-instance v20, Ljava/lang/StringBuilder;
    ...
    const-string v20, "SupportedFormats"
    ...
    .end local v4           #SupportedFormats:Ljava/lang/String;
    :cond_5
    add-int/lit8 v12, v12, 0x1

    goto/16 :goto_2

    .end local v19           #uuid:Landroid/os/ParcelUuid;
    :cond_6
    ...
    check-cast v19, Landroid/os/ParcelUuid;

    .restart local v19       #uuid:Landroid/os/ParcelUuid;
    move-object v0, v9
    ...
    const-string v21, "\tuuid(application): "
    ...
    const-string v21, "Making callback for "
    ...
    :try_start_5
    const-string v20, "BluetoothService"
