...
.method static synthetic access$3400(Landroid/server/BluetoothService$BondState;Ljava/lang/String;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private copyAutoPairingData()V
    ...
    invoke-static {v9}, Landroid/server/BluetoothService;->access$3100(Ljava/lang/String;)V
    :try_end_7
...
.method private updateAutoPairingData(Ljava/lang/String;)V
    ...
    #calls: Landroid/server/BluetoothService;->log(Ljava/lang/String;)V
    invoke-static {v4}, Landroid/server/BluetoothService;->access$3100(Ljava/lang/String;)V
    :try_end_3
...
.method public declared-synchronized loadBondState()V
    ...
    invoke-static {v6}, Landroid/server/BluetoothService;->access$3000(Landroid/server/BluetoothService;)I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    #calls: Landroid/server/BluetoothService;->log(Ljava/lang/String;)V
    invoke-static {v6}, Landroid/server/BluetoothService;->access$3100(Ljava/lang/String;)V
...
.method public readAutoPairingData()V
    ...
    #calls: Landroid/server/BluetoothService;->log(Ljava/lang/String;)V
    invoke-static {v8}, Landroid/server/BluetoothService;->access$3100(Ljava/lang/String;)V
    :try_end_2
...
.method public declared-synchronized setBondState(Ljava/lang/String;II)V
    ...
    invoke-static {v2, p1}, Landroid/server/BluetoothService;->access$3200(Landroid/server/BluetoothService;Ljava/lang/String;)Landroid/bluetooth/BluetoothDeviceProfileState;
    ...
    #calls: Landroid/server/BluetoothService;->log(Ljava/lang/String;)V
    invoke-static {v2}, Landroid/server/BluetoothService;->access$3100(Ljava/lang/String;)V
    ...
    invoke-static {v3}, Landroid/server/BluetoothService;->access$3300(Landroid/server/BluetoothService;)Landroid/bluetooth/BluetoothAdapter;
    ...
    invoke-static {v2}, Landroid/server/BluetoothService;->access$500(Landroid/server/BluetoothService;)Landroid/content/Context;
