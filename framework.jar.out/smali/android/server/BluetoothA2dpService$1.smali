...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v1}, Landroid/server/BluetoothA2dpService;->access$000(Ljava/lang/String;)V
    ...
    invoke-static {v1, v2}, Landroid/server/BluetoothA2dpService;->access$100(Landroid/server/BluetoothA2dpService;Z)Z
    ...
    invoke-static {v1}, Landroid/server/BluetoothA2dpService;->access$200(Landroid/server/BluetoothA2dpService;)Landroid/os/Handler;
    ...
    const-string v2, "Timed outM - Sending Playstatus"

    invoke-static {v1, v2}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v1, p0, Landroid/server/BluetoothA2dpService$1;->this$0:Landroid/server/BluetoothA2dpService;

    iget-object v2, p0, Landroid/server/BluetoothA2dpService$1;->this$0:Landroid/server/BluetoothA2dpService;

    #getter for: Landroid/server/BluetoothA2dpService;->mPlayStatusRequestPath:Ljava/lang/String;
    invoke-static {v2}, Landroid/server/BluetoothA2dpService;->access$300(Landroid/server/BluetoothA2dpService;)Ljava/lang/String;

    move-result-object v2

    #calls: Landroid/server/BluetoothA2dpService;->sendPlayStatus(Ljava/lang/String;)V
    invoke-static {v1, v2}, Landroid/server/BluetoothA2dpService;->access$400(Landroid/server/BluetoothA2dpService;Ljava/lang/String;)V
