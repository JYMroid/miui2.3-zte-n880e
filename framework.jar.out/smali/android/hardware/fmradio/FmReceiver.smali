...
.field public static final SRCH_ABORTED:I = -0x2

.field public static final SRCH_COMPLETE:I = 0x0

.field public static final SRCH_FAILED:I = -0x1

.field public static final SRCH_INPROGRESS:I = 0x1
...
.method public cancelSearch()Z
    ...
    const-string v2, "cancelSearch: No on going search operation to cancel"
...
.method public disable()Z
    ...
    const-string v3, "disable: CURRENT-STATE : FMRxOn ---> NEW-STATE : FMTurningOff"
    ...
    const-string v3, "FM already tuned Off."
    ...
    const-string v3, "disable: Cancelling the on going search operation prior to disabling FM"
    ...
    const-string v3, "disable: Wait for the state to change from : Search ---> FMRxOn"
    ...
    const-string v3, "disable: FM in bad state"
    ...
    const-string v3, "disable: FM is getting turned Off."
...
.method public enable(Landroid/hardware/fmradio/FmConfig;)Z
    ...
    const-string v3, "enable: FM already turned On and running"
    ...
    const-string v3, "FM is in the process of turning off.Pls wait for sometime."
    ...
    const-string v3, "FM is in the process of turning On.Pls wait for sometime."
    ...
    .end local v2           #status:I
    :cond_3
    invoke-static {v6}, Landroid/hardware/fmradio/FmReceiver;->setFMPowerState(I)V

    const-string v3, "FMRadio"

    const-string v3, "enable: CURRENT-STATE : FMOff ---> NEW-STATE : FMRxStarting"
    ...
    const-string v3, "enable: Error while turning FM On"

    invoke-static {v4, v3}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    const-string v3, "FMRadio"

    const-string v3, "enable: CURRENT-STATE : FMRxStarting ---> NEW-STATE : FMOff"
...
.method public enableAFjump(Z)Z
    ...
    const-string v3, "enableAFjump: Device currently busy in executing another command."
    ...
    invoke-virtual {v2, v3}, Landroid/hardware/fmradio/FmRxRdsData;->rdsOn(Z)I
    ...
    invoke-virtual {v2, p1}, Landroid/hardware/fmradio/FmRxRdsData;->enableAFjump(Z)I
...
.method public getSignalThreshold()I
    ...
    const-string v4, "getSignalThreshold: Device currently busy in executing another command."
...
.method public getTunedFrequency()I
    ...
    const-string v2, "getTunedFrequency: Device currently busy in executing another command."
...
.method public registerRdsGroupProcessing(I)Z
    ...
    const-string v3, "registerRdsGroupProcessing: Device currently busy in executing another command."
    ...
    invoke-virtual {v2, p1}, Landroid/hardware/fmradio/FmRxRdsData;->rdsOptions(I)I
...
.method public searchStations(III)Z
    ...
    const-string v0, "searchStations: Device currently busy in executing another command."
    ...
    const-string v0, "searchStations: CURRENT-STATE : FMRxOn ---> NEW-STATE : SearchInProg"
...
.method public setMuteMode(I)Z
    ...
    const-string v2, "setMuteMode: Device currently busy in executing another command."
    ...
    invoke-virtual {v1, v2, v3}, Landroid/hardware/fmradio/FmRxControls;->muteControl(IZ)V
    ...
    invoke-virtual {v1, v2, v4}, Landroid/hardware/fmradio/FmRxControls;->muteControl(IZ)V
...
.method public setRdsGroupOptions(IIZ)Z
    ...
    const-string v3, "setRdsGroupOptions: Device currently busy in executing another command."
    ...
    invoke-virtual {v2, p1, p2, p3}, Landroid/hardware/fmradio/FmRxRdsData;->rdsGrpOptions(IIZ)I
...
.method public setSignalThreshold(I)Z
    ...
    const-string v4, "setSignalThreshold: Device currently busy in executing another command."
...
.method public setStereoMode(Z)Z
    ...
    const-string v3, "setStereoMode: Device currently busy in executing another command."
    ...
    invoke-virtual {v2, v3, p1}, Landroid/hardware/fmradio/FmRxControls;->stereoControl(IZ)I
