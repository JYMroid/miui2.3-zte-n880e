...
.method public createFromParcel(Landroid/os/Parcel;)Landroid/net/NetworkInfo;
    ...
    #setter for: Landroid/net/NetworkInfo;->mIpv4Apn:Ljava/lang/String;
    invoke-static {v0, v5}, Landroid/net/NetworkInfo;->access$902(Landroid/net/NetworkInfo;Ljava/lang/String;)Ljava/lang/String;

    invoke-virtual {p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v5

    #setter for: Landroid/net/NetworkInfo;->mIpv6Apn:Ljava/lang/String;
    invoke-static {v0, v5}, Landroid/net/NetworkInfo;->access$1002(Landroid/net/NetworkInfo;Ljava/lang/String;)Ljava/lang/String;

    invoke-virtual {p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v5

    #setter for: Landroid/net/NetworkInfo;->mIpv4Interface:Ljava/lang/String;
    invoke-static {v0, v5}, Landroid/net/NetworkInfo;->access$1102(Landroid/net/NetworkInfo;Ljava/lang/String;)Ljava/lang/String;

    invoke-virtual {p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v5

    #setter for: Landroid/net/NetworkInfo;->mIpv6Interface:Ljava/lang/String;
    invoke-static {v0, v5}, Landroid/net/NetworkInfo;->access$1202(Landroid/net/NetworkInfo;Ljava/lang/String;)Ljava/lang/String;
