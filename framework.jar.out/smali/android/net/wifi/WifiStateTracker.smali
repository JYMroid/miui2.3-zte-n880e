...
.field private static final EVENT_DHCP_RENEW:I = 0x14
...
.field private static final EVENT_WPS:I = 0x10

.field private static final ICON_NETWORKS_AVAILABLE:I = 0x10802d4

.field private static final INFINITE_RENEWAL_TIME:I = -0x1
...
.field private static final MAX_RENEWAL_TIME_SECS:I = 0x93a80
...
.field private final mDhcpLock:Ljava/lang/Object;
...
.field private mDhcpStartWakeLock:Landroid/os/PowerManager$WakeLock;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    iput-boolean v4, p0, Landroid/net/wifi/WifiStateTracker;->isWpaRekeying:Z
    ...
    iput-object v0, p0, Landroid/net/wifi/WifiStateTracker;->mDhcpLock:Ljava/lang/Object;
    ...
    invoke-virtual {v8, v3, v10}, Landroid/os/PowerManager;->newWakeLock(ILjava/lang/String;)Landroid/os/PowerManager$WakeLock;
    ...
    iput-object v0, p0, Landroid/net/wifi/WifiStateTracker;->mDhcpStartWakeLock:Landroid/os/PowerManager$WakeLock;

    iget-object v0, p0, Landroid/net/wifi/WifiStateTracker;->mDhcpStartWakeLock:Landroid/os/PowerManager$WakeLock;
...
.method static synthetic access$1000(Landroid/net/wifi/WifiStateTracker;)Landroid/app/PendingIntent;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1100(Landroid/net/wifi/WifiStateTracker;)Landroid/app/AlarmManager;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1800(Landroid/net/wifi/WifiStateTracker;)Landroid/os/Handler;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1900(Landroid/net/wifi/WifiStateTracker;)Landroid/content/Context;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2000(Landroid/net/wifi/WifiStateTracker;)Z
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2002(Landroid/net/wifi/WifiStateTracker;Z)Z
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2100(Landroid/net/wifi/WifiStateTracker;)V
    .locals 0
    .parameter "x0"
...
.method static synthetic access$2200(Landroid/net/wifi/WifiStateTracker;)Landroid/content/Context;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$500(Landroid/net/wifi/WifiStateTracker;)Landroid/os/PowerManager$WakeLock;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$800(Landroid/net/wifi/WifiStateTracker;)Landroid/net/NetworkInfo;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$900(Landroid/net/wifi/WifiStateTracker;)Landroid/os/Handler;
    .locals 1
    .parameter "x0"
...
.method private configureInterface()V
    ...
    const-string v2, "configureInterface(), DHCP, mHaveIpAddress: "
    ...
    const-string v2, ", mObtainingIpAddress: "
    ...
    iget-object v1, p0, Landroid/net/wifi/WifiStateTracker;->mDhcpLock:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, Landroid/net/wifi/WifiStateTracker;->mDhcpTarget:Landroid/net/wifi/WifiStateTracker$DhcpHandler;

    const/16 v3, 0x9

    invoke-virtual {v2, v3}, Landroid/net/wifi/WifiStateTracker$DhcpHandler;->sendEmptyMessage(I)Z
...
.method private requestConnectionStatus(Landroid/net/wifi/WifiInfo;)V
    ...
    invoke-virtual/range {v18 .. v18}, Landroid/net/wifi/WifiInfo;->getSupplicantState()Landroid/net/wifi/SupplicantState;
...
.method private declared-synchronized requestPolledInfo(Landroid/net/wifi/WifiInfo;Z)V
    ...
    const-string v5, "WifiManager.calculateSignalLevel("
...
.method public getGateway(Lcom/android/internal/net/IPVersion;)Ljava/net/InetAddress;
    .locals 1
    .parameter "ipv"
...
.method public getInterfaceName(Lcom/android/internal/net/IPVersion;)Ljava/lang/String;
    .locals 1
    .parameter "ipv"
...
.method public getIpAdress(Lcom/android/internal/net/IPVersion;)Ljava/net/InetAddress;
    .locals 1
    .parameter "ipv"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :pswitch_1
    const-string v24, "wps_string"

    .local v24, wpsEventName:Ljava/lang/String;
    move-object/from16 v0, p1
    ...
    check-cast v23, Landroid/net/wifi/WifiStateTracker$WpsEventComing;

    .local v23, wpsEvent:Landroid/net/wifi/WifiStateTracker$WpsEventComing;
    ...
    const-string v27, "Handling EVENT_WPS, msg ["
    ...
    const-string v25, "android.net.wifi.supplicant.WPS_EVENT"
    ...
    const-string v26, "WPS-AP-AVAILABLE-PBC"
    ...
    const-string v26, "WPS-AP-AVAILABLE-PIN"
    ...
    const-string v26, "WPS-CRED-RECEIVED"
    ...
    .end local v23           #wpsEvent:Landroid/net/wifi/WifiStateTracker$WpsEventComing;
    .end local v24           #wpsEventName:Ljava/lang/String;
    :pswitch_2
    const/16 v25, 0x2
    ...
    const-string v26, "EVENT_SUPPLICANT_CONNECTION--->resetNotificationTimer()"
    ...
    const-string v25, "DHCP Handler Thread"
    ...
    iget-object v0, v0, Landroid/net/wifi/WifiStateTracker;->mDhcpLock:Ljava/lang/Object;
    ...
    iput-boolean v0, v1, Landroid/net/wifi/WifiStateTracker;->isWpaRekeying:Z
    ...
    invoke-virtual/range {v25 .. v25}, Landroid/net/wifi/WifiInfo;->getSupplicantState()Landroid/net/wifi/SupplicantState;
    ...
    const-string v27, "Connection to supplicant established, state="
    ...
    sget-object v25, Landroid/net/wifi/SupplicantState;->COMPLETED:Landroid/net/wifi/SupplicantState;
    ...
    const-string v26, "Supplicant state change to COMPLETED, so start DHCP"
    ...
    const-string v25, "android.net.wifi.supplicant.CONNECTION_CHANGE"
    ...
    invoke-virtual/range {v25 .. v25}, Landroid/net/wifi/WifiManager;->initializeMulticastFiltering()Z
    ...
    new-instance v25, Landroid/bluetooth/BluetoothA2dp;
    ...
    invoke-direct/range {v25 .. v26}, Landroid/bluetooth/BluetoothA2dp;-><init>(Landroid/content/Context;)V
    ...
    const-string v26, "Supplicant died unexpectedly"
    ...
    invoke-virtual/range {v25 .. v26}, Landroid/content/Context;->removeStickyBroadcast(Landroid/content/Intent;)V
    ...
    const-string v27, "android.net.wifi.NO_MORE_WIFI_LOCKS"
    ...
    const-string v26, "Connection to supplicant lost"
    ...
    const-string v27, "Changing supplicant state: "
    ...
    sget-object v25, Landroid/net/wifi/SupplicantState;->INACTIVE:Landroid/net/wifi/SupplicantState;
    ...
    const-string v26, "Stop WPA supplicant loop and disable network"
    ...
    iget-boolean v0, v0, Landroid/net/wifi/WifiStateTracker;->isWpaRekeying:Z
    ...
    const-string v26, "WPA rekeying exit!"
    ...
    sget-object v25, Landroid/net/wifi/SupplicantState;->FOUR_WAY_HANDSHAKE:Landroid/net/wifi/SupplicantState;
    ...
    sget-object v25, Landroid/net/wifi/SupplicantState;->GROUP_HANDSHAKE:Landroid/net/wifi/SupplicantState;
    ...
    const-string v26, "WPA is rekeying now!"
    ...
    const-string v26, "WPA rekeying error!"
    ...
    const-string v27, "Failed to authenticate, disabling network "
    ...
    const-string v25, "supplicantError"
    ...
    const-string v27, "New network state is "
    ...
    const-string v26, "Dropping event in scan-only mode"
    ...
    sget-object v26, Landroid/net/NetworkInfo$DetailedState;->SCANNING:Landroid/net/NetworkInfo$DetailedState;
    ...
    const-string v26, "Network state change to CONNECTED, so start DHCP..."
    ...
    :cond_2f
    sget-object v25, Landroid/net/NetworkInfo$DetailedState;->OBTAINING_IPADDR:Landroid/net/NetworkInfo$DetailedState;
    ...
    const-string v27, "android.net.wifi.SCAN_RESULTS"
    ...
    const-string v27, "Failed reconnect count: "
    ...
    invoke-virtual/range {v25 .. v26}, Landroid/net/wifi/WifiManager;->disableNetwork(I)Z
    ...
    invoke-virtual/range {v25 .. v26}, Landroid/net/wifi/WifiInfo;->setIpAddress(I)V
    ...
    const-string v27, "IP configuration: "
    ...
    const-string v26, "EVENT_INTERFACE_CONFIGURATION_SUCCEEDED--->resetNotificationTimer()"
    ...
    const-string v26, "Wifi Driver reports HUNG - reloading."
...
.method public interpretScanResultsAvailable()V
    ...
    const-string v7, "setNotificationVisible() scanResult.SSID="
    ...
    const-string v7, "interpretScanResultsAvailable() numOpenNetworks="
    ...
    const-string v7, " mNumScansSinceNetworkStateChange="

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget v7, p0, Landroid/net/wifi/WifiStateTracker;->mNumScansSinceNetworkStateChange:I
...
.method notifyWpsEvent(Landroid/net/NetworkInfo$SpecDetailedState;Ljava/lang/String;)V
    .locals 3
    .parameter "newState"
    .parameter "wpsEvent"
    ...
    invoke-direct {v2, p1, p2}, Landroid/net/wifi/WifiStateTracker$WpsEventComing;-><init>(Landroid/net/NetworkInfo$SpecDetailedState;Ljava/lang/String;)V
...
.method public resetConnections(Z)V
    ...
    iget-object v0, p0, Landroid/net/wifi/WifiStateTracker;->mDhcpLock:Ljava/lang/Object;
...
.method public setNotificationVisible(ZIZI)V
    ...
    const-string v5, " mNotificationShown="

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-boolean v5, p0, Landroid/net/wifi/WifiStateTracker;->mNotificationShown:Z
    ...
    const-string v5, "setNotificationVisible() System.currentTimeMillis()="
    ...
    const-string v5, "setNotificationVisible() mNotificationRepeatTime="
    ...
    const-string v4, "setNotificationVisible() System.currentTimeMillis() < mNotificationRepeatTime return."
