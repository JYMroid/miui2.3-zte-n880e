...
.field public static final WAPI_AS_CERTIFICATE:Ljava/lang/String; = "/data/misc/wifi/cert/as/"

.field public static final WAPI_HEX_PASSWORD:I = 0x1

.field public static final WAPI_USER_CERTIFICATE:Ljava/lang/String; = "/data/misc/wifi/cert/user/"
...
.field public ap_AuthAlgorithm:I

.field public ap_ChannelNum:I

.field public ap_CurClientsNum:I

.field public ap_DhcpEnable:Ljava/lang/String;

.field public ap_DhcpIPEnd:Ljava/lang/String;

.field public ap_DhcpIPStart:Ljava/lang/String;

.field public ap_DhcpLeaseTime:Ljava/lang/String;

.field public ap_IPAddr:I

.field public ap_IPNetMask:I

.field public ap_MacFilter:Ljava/lang/String;

.field public ap_MaxClients:I

.field public ap_Preamble:I

.field public ap_hideSSID:Z
...
.method public constructor <init>()V
    ...
    :cond_1
    iput v9, p0, Landroid/net/wifi/WifiConfiguration;->ap_AuthAlgorithm:I

    const/4 v5, 0x6

    iput v5, p0, Landroid/net/wifi/WifiConfiguration;->ap_ChannelNum:I

    iput v9, p0, Landroid/net/wifi/WifiConfiguration;->ap_Preamble:I

    iput v11, p0, Landroid/net/wifi/WifiConfiguration;->ap_MaxClients:I

    iput-boolean v9, p0, Landroid/net/wifi/WifiConfiguration;->ap_hideSSID:Z

    const v5, -0x3f57d4ff

    iput v5, p0, Landroid/net/wifi/WifiConfiguration;->ap_IPAddr:I

    const/16 v5, -0x100

    iput v5, p0, Landroid/net/wifi/WifiConfiguration;->ap_IPNetMask:I

    const-string v5, "enable"

    iput-object v5, p0, Landroid/net/wifi/WifiConfiguration;->ap_DhcpEnable:Ljava/lang/String;

    const-string v5, "192.168.43.100"

    iput-object v5, p0, Landroid/net/wifi/WifiConfiguration;->ap_DhcpIPStart:Ljava/lang/String;

    const-string v5, "192.168.43.254"

    iput-object v5, p0, Landroid/net/wifi/WifiConfiguration;->ap_DhcpIPEnd:Ljava/lang/String;

    const-string v5, "1h"

    iput-object v5, p0, Landroid/net/wifi/WifiConfiguration;->ap_DhcpLeaseTime:Ljava/lang/String;

    iput v11, p0, Landroid/net/wifi/WifiConfiguration;->ap_CurClientsNum:I

    const-string v5, "MAC_MODE=0,MAC_CNT=0,MAC="

    iput-object v5, p0, Landroid/net/wifi/WifiConfiguration;->ap_MacFilter:Ljava/lang/String;
...
.method public toString()Ljava/lang/String;
    ...
    const-string v11, " WAPI Cert Index: "
    ...
    const-string v11, " WAPI PSK Key Type: "
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget v5, p0, Landroid/net/wifi/WifiConfiguration;->ap_AuthAlgorithm:I

    invoke-virtual {p1, v5}, Landroid/os/Parcel;->writeInt(I)V

    iget v5, p0, Landroid/net/wifi/WifiConfiguration;->ap_ChannelNum:I

    invoke-virtual {p1, v5}, Landroid/os/Parcel;->writeInt(I)V

    iget v5, p0, Landroid/net/wifi/WifiConfiguration;->ap_Preamble:I

    invoke-virtual {p1, v5}, Landroid/os/Parcel;->writeInt(I)V

    iget v5, p0, Landroid/net/wifi/WifiConfiguration;->ap_MaxClients:I

    invoke-virtual {p1, v5}, Landroid/os/Parcel;->writeInt(I)V

    iget-boolean v5, p0, Landroid/net/wifi/WifiConfiguration;->ap_hideSSID:Z
    ...
    iget v5, p0, Landroid/net/wifi/WifiConfiguration;->ap_IPAddr:I

    invoke-virtual {p1, v5}, Landroid/os/Parcel;->writeInt(I)V

    iget v5, p0, Landroid/net/wifi/WifiConfiguration;->ap_IPNetMask:I

    invoke-virtual {p1, v5}, Landroid/os/Parcel;->writeInt(I)V

    iget-object v5, p0, Landroid/net/wifi/WifiConfiguration;->ap_DhcpEnable:Ljava/lang/String;

    invoke-virtual {p1, v5}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    iget-object v5, p0, Landroid/net/wifi/WifiConfiguration;->ap_DhcpIPStart:Ljava/lang/String;

    invoke-virtual {p1, v5}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    iget-object v5, p0, Landroid/net/wifi/WifiConfiguration;->ap_DhcpIPEnd:Ljava/lang/String;

    invoke-virtual {p1, v5}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    iget-object v5, p0, Landroid/net/wifi/WifiConfiguration;->ap_DhcpLeaseTime:Ljava/lang/String;

    invoke-virtual {p1, v5}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    iget v5, p0, Landroid/net/wifi/WifiConfiguration;->ap_CurClientsNum:I

    invoke-virtual {p1, v5}, Landroid/os/Parcel;->writeInt(I)V

    iget-object v5, p0, Landroid/net/wifi/WifiConfiguration;->ap_MacFilter:Ljava/lang/String;
