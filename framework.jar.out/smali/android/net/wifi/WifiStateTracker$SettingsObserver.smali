...
.method public constructor <init>(Landroid/net/wifi/WifiStateTracker;Landroid/os/Handler;)V
    ...
    invoke-static {p1}, Landroid/net/wifi/WifiStateTracker;->access$1200(Landroid/net/wifi/WifiStateTracker;)Landroid/content/Context;
...
.method public onChange(Z)V
    ...
    invoke-static {v8}, Landroid/net/wifi/WifiStateTracker;->access$1300(Landroid/net/wifi/WifiStateTracker;)Z
    ...
    invoke-static {v8}, Landroid/net/wifi/WifiStateTracker;->access$1600(Landroid/net/wifi/WifiStateTracker;)V
    ...
    invoke-static {v8}, Landroid/net/wifi/WifiStateTracker;->access$1800(Landroid/net/wifi/WifiStateTracker;)Landroid/os/Handler;
    ...
    #getter for: Landroid/net/NetworkStateTracker;->mNetworkInfo:Landroid/net/NetworkInfo;
    invoke-static {v10}, Landroid/net/wifi/WifiStateTracker;->access$1700(Landroid/net/wifi/WifiStateTracker;)Landroid/net/NetworkInfo;
