...
.method handleEvent(ILjava/lang/String;)V
    ...
    #calls: Landroid/net/wifi/WifiMonitor;->handleSpecNetworkStateChange(Landroid/net/NetworkInfo$SpecDetailedState;Ljava/lang/String;)V
    invoke-static {v0, v1, p2}, Landroid/net/wifi/WifiMonitor;->access$500(Landroid/net/wifi/WifiMonitor;Landroid/net/NetworkInfo$SpecDetailedState;Ljava/lang/String;)V
...
.method public run()V
    ...
    #getter for: Landroid/net/wifi/WifiMonitor;->mWifiStateTracker:Landroid/net/wifi/WifiStateTracker;
    invoke-static {v8}, Landroid/net/wifi/WifiMonitor;->access$000(Landroid/net/wifi/WifiMonitor;)Landroid/net/wifi/WifiStateTracker;

    move-result-object v8

    invoke-virtual {v8}, Landroid/net/wifi/WifiStateTracker;->notifySupplicantConnection()V
    ...
    const-string v8, "WPS-AP-AVAILABLE "
    ...
    const-string v9, "Ignore WPS event ["
    ...
    invoke-virtual {v8}, Landroid/net/wifi/WifiStateTracker;->notifySupplicantLost()V
    ...
    .local v7, wpsEventData:Ljava/lang/String;
    invoke-virtual {p0, v6, v7}, Landroid/net/wifi/WifiMonitor$MonitorThread;->handleEvent(ILjava/lang/String;)V

    goto :goto_0

    .end local v6           #wpsEvent:I
    .end local v7           #wpsEventData:Ljava/lang/String;
    :cond_4
    ...
    invoke-static {v8, v12}, Landroid/net/wifi/WifiMonitor;->access$202(Landroid/net/wifi/WifiMonitor;I)I
    ...
    const-string v8, "Monitor socket is closed, exiting thread"
    ...
    invoke-static {v8}, Landroid/net/wifi/WifiMonitor;->access$204(Landroid/net/wifi/WifiMonitor;)I
    ...
    const-string v8, "too many recv errors, closing connection"
