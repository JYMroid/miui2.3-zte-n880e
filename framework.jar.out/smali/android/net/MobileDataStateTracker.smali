...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;ILjava/lang/String;)V
    ...
    const-string v1, "-->Init by MobileDataStateTracker."
    ...
    invoke-virtual {p0, v0}, Landroid/net/MobileDataStateTracker;->logd(Ljava/lang/String;)V
...
.method private getIpVersionFromIntent(Landroid/content/Intent;)Lcom/android/internal/net/IPVersion;
    .locals 2
    .parameter "intent"
...
.method private getMobileDataState(Landroid/content/Intent;)Lcom/android/internal/telephony/Phone$DataState;
    ...
    const-string v2, "+++getMobileDataState() entered."
    ...
    const-string v2, "Entered if: isApnTypeIncluded(apnTypeList)=true.++and return.++"
    ...
    const-string v2, "+++getMobileDataState() returned: Phone.DataState.DISCONNECTED"
...
.method private isApnTypeIncluded(Ljava/lang/String;)Z
    ...
    const-string v3, " isApnTypeIncluded(): typeList = "
    ...
    invoke-virtual {p0, v2}, Landroid/net/MobileDataStateTracker;->logd(Ljava/lang/String;)V

    if-nez p1, :cond_0

    const-string v2, " isApnTypeIncluded() Returned by: typeList==null."
    ...
    :cond_1
    const-string v2, " isApnTypeIncluded() Returned true successfully."
    ...
    :cond_3
    const-string v2, " isApnTypeIncluded() Returned false by: typeList is Unknown."
...
.method private updateMobileInfoFromIntent(Landroid/content/Intent;)Z
    ...
    invoke-direct {p0, p1}, Landroid/net/MobileDataStateTracker;->getIpVersionFromIntent(Landroid/content/Intent;)Lcom/android/internal/net/IPVersion;

    move-result-object v1

    .local v1, ipv:Lcom/android/internal/net/IPVersion;
    ...
    invoke-virtual {p0, v4}, Landroid/net/MobileDataStateTracker;->logd(Ljava/lang/String;)V
    ...
    const-string v5, "updated mobile state info for "
    ...
    invoke-virtual {p0, v1}, Landroid/net/MobileDataStateTracker;->removePrivateDnsRoutes(Lcom/android/internal/net/IPVersion;)V
...
.method public getNameServers()[Ljava/lang/String;
    ...
    sget-object v3, Lcom/android/internal/net/IPVersion;->INET:Lcom/android/internal/net/IPVersion;

    invoke-virtual {p0, v3}, Landroid/net/MobileDataStateTracker;->getInterfaceName(Lcom/android/internal/net/IPVersion;)Ljava/lang/String;
    ...
    sget-object v3, Lcom/android/internal/net/IPVersion;->INET6:Lcom/android/internal/net/IPVersion;
...
.method public reconnect()Z
    ...
    const-string v1, "-->reconnect() entered."
    ...
    invoke-direct {p0, v0, v4}, Landroid/net/MobileDataStateTracker;->setEnableApn(Ljava/lang/String;Z)I
    ...
    const-string v1, "-->case default in reconnect()."
    ...
    const-string v1, "-->returned by reconnect()."
    ...
    const-string v1, "-->case APN_REQUEST_FAILED in reconnect()."
    ...
    const-string v1, "-->case APN_TYPE_NOT_AVAILABLE in reconnect()."
...
.method public requestRouteToHost(Ljava/net/InetAddress;)Z
    ...
    invoke-virtual {p0, v4}, Landroid/net/MobileDataStateTracker;->getInterfaceName(Lcom/android/internal/net/IPVersion;)Ljava/lang/String;
...
.method public startMonitoring()V
    ...
    invoke-direct {p0, v1}, Landroid/net/MobileDataStateTracker;->getIpVersionFromIntent(Landroid/content/Intent;)Lcom/android/internal/net/IPVersion;

    move-result-object v2

    .local v2, ipv:Lcom/android/internal/net/IPVersion;
    ...
    .end local v2           #ipv:Lcom/android/internal/net/IPVersion;
    :cond_0
...
.method public teardown()Z
    ...
    const-string v1, "-->MobileDataStateTracker.teardown() entered."
