...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/inputmethodservice/InputMethodService$CloseSystemDialogsIntentReceiver;,
...
.method public constructor <init>()V
    ...
    new-instance v0, Landroid/inputmethodservice/InputMethodService$CloseSystemDialogsIntentReceiver;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Landroid/inputmethodservice/InputMethodService$CloseSystemDialogsIntentReceiver;-><init>(Landroid/inputmethodservice/InputMethodService;Landroid/inputmethodservice/InputMethodService$1;)V

    iput-object v0, p0, Landroid/inputmethodservice/InputMethodService;->mCloseSystemDialogsReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, Landroid/inputmethodservice/InputMethodService;->mTextEditorWatcher:Landroid/text/TextWatcher;
...
.method static synthetic access$200(Landroid/inputmethodservice/InputMethodService;)V
    ...
    .prologue
    invoke-direct {p0}, Landroid/inputmethodservice/InputMethodService;->updateSendButtonState()V
...
.method private updateSendButtonState()V
    ...
    invoke-virtual {v1}, Landroid/inputmethodservice/ExtractEditText;->length()I
...
.method public onCreate()V
    ...
    iget-object v3, p0, Landroid/inputmethodservice/AbstractInputMethodService;->mDispatcherState:Landroid/view/KeyEvent$DispatcherState;
    ...
    iget-object v1, p0, Landroid/inputmethodservice/InputMethodService;->mCloseSystemDialogsReceiver:Landroid/content/BroadcastReceiver;
...
.method public onDestroy()V
    ...
    :cond_0
    iget-object v0, p0, Landroid/inputmethodservice/InputMethodService;->mCloseSystemDialogsReceiver:Landroid/content/BroadcastReceiver;
...
.method public onFinishPopupDialog()V
    .locals 0
...
.method public onUpdateExtractingViews(Landroid/view/inputmethod/EditorInfo;)V
    ...
    iget-object v2, p0, Landroid/inputmethodservice/InputMethodService;->mTextEditorWatcher:Landroid/text/TextWatcher;

    invoke-virtual {v1, v2}, Landroid/inputmethodservice/ExtractEditText;->addTextChangedListener(Landroid/text/TextWatcher;)V
