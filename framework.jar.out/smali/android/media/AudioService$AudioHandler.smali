...
.method static synthetic access$3700(Landroid/media/AudioService$AudioHandler;Landroid/media/MediaPlayer;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private persistVolume(Landroid/media/AudioService$VolumeStreamState;ZZ)V
    ...
    invoke-static {p1}, Landroid/media/AudioService$VolumeStreamState;->access$3200(Landroid/media/AudioService$VolumeStreamState;)Ljava/lang/String;
    ...
    invoke-static {p1}, Landroid/media/AudioService$VolumeStreamState;->access$3300(Landroid/media/AudioService$VolumeStreamState;)Ljava/lang/String;
...
.method private playSoundEffect(II)V
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$2700(Landroid/media/AudioService;)[Landroid/media/AudioService$VolumeStreamState;
...
.method private setSystemVolume(Landroid/media/AudioService$VolumeStreamState;)V
    ...
    invoke-static {p1}, Landroid/media/AudioService$VolumeStreamState;->access$2800(Landroid/media/AudioService$VolumeStreamState;)I
    ...
    invoke-static {v0, v2, v3}, Landroid/media/AudioService;->access$2400(Landroid/media/AudioService;II)V
    ...
    #getter for: Landroid/media/AudioService;->mStreamStates:[Landroid/media/AudioService$VolumeStreamState;
    invoke-static {v2}, Landroid/media/AudioService;->access$2700(Landroid/media/AudioService;)[Landroid/media/AudioService$VolumeStreamState;
    ...
    #calls: Landroid/media/AudioService;->setStreamVolumeIndex(II)V
    invoke-static {v0, v9, v2}, Landroid/media/AudioService;->access$2400(Landroid/media/AudioService;II)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v4}, Landroid/media/AudioService;->access$3800(I)I
    ...
    invoke-static {v4}, Landroid/media/AudioService;->access$3900(Landroid/media/AudioService;)Ljava/util/HashMap;
    ...
    #getter for: Landroid/media/AudioService;->mStreamStates:[Landroid/media/AudioService$VolumeStreamState;
    invoke-static {v4}, Landroid/media/AudioService;->access$2700(Landroid/media/AudioService;)[Landroid/media/AudioService$VolumeStreamState;
    ...
    invoke-static/range {v18 .. v18}, Landroid/media/AudioService$VolumeStreamState;->access$4100(Landroid/media/AudioService$VolumeStreamState;)I
    ...
    #calls: Landroid/media/AudioService;->setStreamVolumeIndex(II)V
    invoke-static {v0, v1, v2}, Landroid/media/AudioService;->access$2400(Landroid/media/AudioService;II)V
    ...
    invoke-static {v4, v5, v6}, Landroid/media/AudioService;->access$4200(Landroid/media/AudioService;IZ)V
    ...
    invoke-static {v0, v1}, Landroid/media/AudioService;->access$4300(Landroid/media/AudioService;Ljava/lang/String;)V
