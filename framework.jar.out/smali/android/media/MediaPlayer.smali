...
.field private mWakeLockForRS:Landroid/os/PowerManager$WakeLock;
...
.method public constructor <init>()V
    ...
    iput-object v2, p0, Landroid/media/MediaPlayer;->mWakeLockForRS:Landroid/os/PowerManager$WakeLock;

    iput-object v2, p0, Landroid/media/MediaPlayer;->mContext:Landroid/content/Context;

    const/4 v1, 0x0

    iput-boolean v1, p0, Landroid/media/MediaPlayer;->mIsStream:Z
...
.method private IsSdpFile(Ljava/lang/String;)Z
    .locals 5
    .parameter "path"
    ...
    const-string v4, "MediaPlayer.IsSdpFile  path = "
...
.method static synthetic access$800(Landroid/media/MediaPlayer;)Landroid/os/PowerManager$WakeLock;
    .locals 1
    .parameter "x0"

    .prologue
    iget-object v0, p0, Landroid/media/MediaPlayer;->mWakeLockForRS:Landroid/os/PowerManager$WakeLock;
...
.method private isStream(Landroid/content/Context;Landroid/net/Uri;)V
    .locals 2
    .parameter "context"
    .parameter "uri"
    ...
    invoke-direct {p0, v0}, Landroid/media/MediaPlayer;->IsSdpFile(Ljava/lang/String;)Z
    ...
    :goto_0
    iput-boolean v0, p0, Landroid/media/MediaPlayer;->mIsStream:Z
...
.method private notifyPlayingStream(Z)V
    .locals 3
    .parameter "bVideoPlaying"
    ...
    const-string v2, "MediaPlayer.notifyPlayingStream  The current video is a stream!"

    invoke-static {v1, v2}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    new-instance v0, Landroid/content/Intent;

    const-string v1, "com.android.media.stream"
    ...
    iget-boolean v2, p0, Landroid/media/MediaPlayer;->mIsStream:Z
...
.method public setDataSource(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    .prologue
    invoke-direct {p0, p1, p2}, Landroid/media/MediaPlayer;->isStream(Landroid/content/Context;Landroid/net/Uri;)V
...
.method public setDataSource(Landroid/content/Context;Landroid/net/Uri;Ljava/util/Map;)V
    ...
    const-string v1, "MediaPlayer.setDataSource  keep the screen stay bright"
...
.method public setWakeMode(Landroid/content/Context;I)V
    ...
    :cond_2
    iget-object v2, p0, Landroid/media/MediaPlayer;->mWakeLockForRS:Landroid/os/PowerManager$WakeLock;

    if-nez v2, :cond_3

    const/4 v2, 0x1

    const-string v3, "WakeLockForRS"
...
.method public start()V
    ...
    const-string v2, "MediaPlayer.start()  mIsStream = "
    ...
    iget-boolean v0, p0, Landroid/media/MediaPlayer;->mIsStream:Z

    if-eqz v0, :cond_0

    invoke-direct {p0, v3}, Landroid/media/MediaPlayer;->notifyPlayingStream(Z)V
...
.method public stop()V
    ...
    invoke-direct {p0, v1}, Landroid/media/MediaPlayer;->notifyPlayingStream(Z)V
