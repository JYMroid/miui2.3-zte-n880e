...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v4, p0, v9}, Landroid/media/AudioService$AudioServiceBroadcastReceiver;-><init>(Landroid/media/AudioService;Landroid/media/AudioService$1;)V
    ...
    invoke-direct {v4, p0, v9}, Landroid/media/AudioService$MediaButtonBroadcastReceiver;-><init>(Landroid/media/AudioService;Landroid/media/AudioService$1;)V

    iput-object v4, p0, Landroid/media/AudioService;->mMediaButtonReceiver:Landroid/content/BroadcastReceiver;

    iput-boolean v8, p0, Landroid/media/AudioService;->mIsRinging:Z
    ...
    iput-object v4, p0, Landroid/media/AudioService;->mAudioFocusDeathHandlers:Ljava/util/ArrayList;
    ...
    iput-object v4, p0, Landroid/media/AudioService;->mBluetoothHeadsetServiceListener:Landroid/bluetooth/BluetoothHeadset$ServiceListener;
    ...
    const-string v5, "ro.config.vc_call_vol_steps"
    ...
    new-instance v4, Landroid/view/VolumePanel;

    invoke-direct {v4, p1, p0}, Landroid/view/VolumePanel;-><init>(Landroid/content/Context;Landroid/media/AudioService;)V

    iput-object v4, p0, Landroid/media/AudioService;->mVolumePanel:Landroid/view/VolumePanel;
    ...
    iput v4, p0, Landroid/media/AudioService;->mMode:I

    invoke-virtual {p0, v8, v9}, Landroid/media/AudioService;->setMode(ILandroid/os/IBinder;)V

    iput-boolean v10, p0, Landroid/media/AudioService;->mMediaServerOk:Z

    iput v8, p0, Landroid/media/AudioService;->mRingerModeMutedStreams:I

    invoke-virtual {p0}, Landroid/media/AudioService;->getRingerMode()I

    move-result v4

    invoke-direct {p0, v4, v8}, Landroid/media/AudioService;->setRingerModeInt(IZ)V
    ...
    iget-object v5, p0, Landroid/media/AudioService;->mBluetoothHeadsetServiceListener:Landroid/bluetooth/BluetoothHeadset$ServiceListener;

    invoke-direct {v4, p1, v5}, Landroid/bluetooth/BluetoothHeadset;-><init>(Landroid/content/Context;Landroid/bluetooth/BluetoothHeadset$ServiceListener;)V

    iput-object v4, p0, Landroid/media/AudioService;->mBluetoothHeadset:Landroid/bluetooth/BluetoothHeadset;
    ...
    const-string v4, "android.intent.action.FMTX"
    ...
    new-array v4, v2, [Landroid/telephony/PhoneStateListener;
    ...
    invoke-direct {p0, v0}, Landroid/media/AudioService;->getPhoneStateListener(I)Landroid/telephony/PhoneStateListener;
...
.method private getActiveStreamType(I)I
    ...
    const-string v3, "getActiveStreamType: Forcing STREAM_FM..."
    ...
    :cond_5
    invoke-static {}, Landroid/media/AudioService;->isBroadcomFMActive()Z
...
.method private getPhoneStateListener(I)Landroid/telephony/PhoneStateListener;
    ...
    invoke-direct {v0, p0, p1}, Landroid/media/AudioService$3;-><init>(Landroid/media/AudioService;I)V
...
.method public static isBroadcomFMActive()Z
    .locals 5
    ...
    invoke-virtual {v0}, Lcom/broadcom/bt/service/framework/PowerManager;->isfmEnabled()Z
    ...
    const-string v4, "liying    isBroadcomFMActive = "
...
# virtual methods
.method public Dolby_SetEnable(I)I
    .locals 1
    .parameter "enable"
...
.method public Dolby_SetMode(I)I
    .locals 1
    .parameter "mode"
...
.method public Dolby_SetParams(IIIIIIIIII)I
    .locals 1
    .parameter "idx"
    .parameter "_tdas_slc"
    .parameter "_tdas_nb"
...
.method public Dolby_SetScene(I)I
    .locals 1
    .parameter "scene"
...
.method public adjustStreamVolume(III)V
    ...
    iget-object v0, v0, Landroid/media/AudioService;->STREAM_VOLUME_ALIAS:[I
    ...
    invoke-direct {v0, v1, v2, v3}, Landroid/media/AudioService;->sendVolumeUpdate(III)V
    ...
    const-string v4, "AudioService.java"

    const-string v5, "liying, STREAM_FM == true , ACTION_SETFMVOL"

    invoke-static {v4, v5}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    const-string v12, "com.broadcom.bt.app.fm.ACTION_SETFMVOL"

    .local v12, ACTION_SETFMVOL:Ljava/lang/String;
    ...
    .end local v12           #ACTION_SETFMVOL:Ljava/lang/String;
    ...
    .restart local v13       #adjustVolume:Z
    ...
    invoke-static/range {v4 .. v11}, Landroid/media/AudioService;->sendMsg(Landroid/os/Handler;IIIIILjava/lang/Object;I)V
...
.method public adjustSuggestedStreamVolume(III)V
    ...
    const-string v1, "AudioService.java"

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "liying,adjustSuggestedStreamVolume() suggestedStreamType  == "
