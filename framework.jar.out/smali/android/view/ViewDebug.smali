...
.method private static findViewByCoordinate(Landroid/view/ViewGroup;IILjava/io/BufferedWriter;)Landroid/view/View;
    ...
    .end local v0           #groupview:Landroid/view/View;
    const/4 v0, 0x1
...
.method private static getcoor(Landroid/view/View;Ljava/io/OutputStream;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .local v4, out:Ljava/io/BufferedWriter;
    sput v10, Landroid/view/ViewDebug;->widget_count:I
...
.method private static isRequestedViewByCoordinate(Ljava/lang/Object;IIIILjava/io/BufferedWriter;)Z
    ...
    .local v9, get_width:Z
    const/4 v8, 0x0

    .local v8, get_height:Z
    const/4 v6, 0x0
    ...
    .local v3, AttributeContent:Ljava/lang/String;
    move v12, v10

    .end local v10           #have_mtext:Z
    .local v12, have_mtext:Z
    move-object v15, v11

    .end local v11           #klass:Ljava/lang/Class;,"Ljava/lang/Class<*>;"
    .local v15, klass:Ljava/lang/Class;,"Ljava/lang/Class<*>;"
    move v11, v9

    .end local v6           #fit_x:Z
    .end local v9           #get_width:Z
    .local v11, get_width:Z
    :goto_0
    invoke-static {v15}, Landroid/view/ViewDebug;->getExportedPropertyFields(Ljava/lang/Class;)[Ljava/lang/reflect/Field;
    ...
    .end local v12           #have_mtext:Z
    .local v13, have_mtext:Z
    move v6, v5

    .end local v5           #coordinate_right:I
    .local v6, coordinate_right:I
    move v12, v11

    .end local v11           #get_width:Z
    .local v12, get_width:Z
    move v11, v8

    .end local v8           #get_height:Z
    .local v11, get_height:Z
    move v5, v4

    .end local v4           #coordinate_bottom:I
    .end local v7           #fit_y:Z
    .local v5, coordinate_bottom:I
    :goto_1
    if-ge v14, v9, :cond_2
    ...
    const-string v16, "mMeasuredWidth"
    ...
    .end local v6           #coordinate_right:I
    .local v4, coordinate_right:I
    move v8, v13

    .end local v13           #have_mtext:Z
    .local v8, have_mtext:Z
    move v6, v11

    .end local v11           #get_height:Z
    .local v6, get_height:Z
    move v7, v12

    .end local v12           #get_width:Z
    .local v7, get_width:Z
    move/from16 v17, v4

    .end local v4           #coordinate_right:I
    .local v17, coordinate_right:I
    move v4, v5

    .end local v5           #coordinate_bottom:I
    .local v4, coordinate_bottom:I
    move/from16 v5, v17

    .end local v17           #coordinate_right:I
    .local v5, coordinate_right:I
    :goto_3
    ...
    .end local v8           #have_mtext:Z
    .restart local v13       #have_mtext:Z
    move v12, v7

    .end local v7           #get_width:Z
    .restart local v12       #get_width:Z
    move v11, v6

    .end local v6           #get_height:Z
    .local v11, get_height:Z
    move v6, v5
    ...
    :cond_0
    const-string v16, "mMeasuredHeight"
    ...
    .local v7, field:Ljava/lang/reflect/Field;
    .local v8, fieldValue:Ljava/lang/Object;
    .restart local v11       #get_height:Z
    .restart local v12       #get_width:Z
    .restart local v13       #have_mtext:Z
    :catch_1
    move-exception v4
    ...
    .end local v15           #klass:Ljava/lang/Class;,"Ljava/lang/Class<*>;"
    .local p0, klass:Ljava/lang/Class;,"Ljava/lang/Class<*>;"
    :goto_9
    return p1

    .end local v4           #fit_x:Z
    .end local v7           #fit_y:Z
    .restart local v9       #fieldcount:I
    .restart local v15       #klass:Ljava/lang/Class;,"Ljava/lang/Class<*>;"
    .local p0, view:Ljava/lang/Object;
    .restart local p1
    .restart local p2
    :cond_3
    const/4 v4, 0x0
    ...
    .end local v8           #klass:Ljava/lang/Class;,"Ljava/lang/Class<*>;"
    .local p0, klass:Ljava/lang/Class;,"Ljava/lang/Class<*>;"
    goto :goto_9

    .restart local v8       #klass:Ljava/lang/Class;,"Ljava/lang/Class<*>;"
    .local p0, view:Ljava/lang/Object;
    :cond_6
    move-object v15, v8
    ...
    .end local v6           #coordinate_right:I
    .restart local v17       #coordinate_right:I
    move v6, v4
    ...
    .end local v5           #coordinate_bottom:I
    .restart local v4       #coordinate_bottom:I
    move v8, v13
...
.method private static isRequestedViewByMtext(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .local v0, if_deletebutton:Z
    const-string v0, "Button"

    .end local v0           #if_deletebutton:Z
    ...
    .local p2, if_deletebutton:Z
    move v8, p2

    .end local p2           #if_deletebutton:Z
    .local v8, if_deletebutton:Z
    move-object v9, v1
    ...
    :goto_0
    invoke-static {v9}, Landroid/view/ViewDebug;->getExportedPropertyFields(Ljava/lang/Class;)[Ljava/lang/reflect/Field;
    ...
    .local p2, AttributeContent:Ljava/lang/String;
    const/4 v1, 0x0

    .local v1, IfContain:Z
    const/16 v2, -0xa

    .local v2, SubStringIndex:I
    const-string p2, "mText"

    .end local p2           #AttributeContent:Ljava/lang/String;
    ...
    .restart local p2       #AttributeContent:Ljava/lang/String;
    ...
    .end local v1           #IfContain:Z
    .local p2, IfContain:Z
    :goto_4
    ...
    .end local v2           #SubStringIndex:I
    .end local v9           #klass:Ljava/lang/Class;,"Ljava/lang/Class<*>;"
    .end local p1
    .end local p2           #IfContain:Z
    .local p0, klass:Ljava/lang/Class;,"Ljava/lang/Class<*>;"
    :goto_5
    return p1
    ...
    .end local v7           #i:I
    .end local v8           #if_deletebutton:Z
    .local v0, ButtonIndex:I
    .local v1, klass:Ljava/lang/Class;,"Ljava/lang/Class<*>;"
    .local p0, view:Ljava/lang/Object;
    .restart local p1
    ...
    .end local p2           #if_deletebutton:Z
    .restart local v8       #if_deletebutton:Z
    move-object v9, v1
    ...
    .local p2, classname:Ljava/lang/String;
    :cond_2
    const/4 p2, 0x1
    ...
    .local v0, AttributeName:Ljava/lang/String;
    .local v1, IfContain:Z
    .restart local v2       #SubStringIndex:I
    ...
    .end local p2           #klass:Ljava/lang/Class;,"Ljava/lang/Class<*>;"
    .local p0, klass:Ljava/lang/Class;,"Ljava/lang/Class<*>;"
    goto :goto_5

    .local p0, view:Ljava/lang/Object;
    .restart local p2       #klass:Ljava/lang/Class;,"Ljava/lang/Class<*>;"
    :cond_7
    move-object v9, p2
    ...
    .end local v4           #fieldValue:Ljava/lang/Object;
    .local p2, fieldValue:Ljava/lang/Object;
    goto :goto_2
.end method
...
.method private static isRequestedViewByPro(Landroid/view/View;Ljava/lang/String;I)Z
    ...
    sget v1, Landroid/view/ViewDebug;->widget_count:I

    add-int/lit8 v1, v1, 0x1

    sput v1, Landroid/view/ViewDebug;->widget_count:I
