...
.method private showCharacterPicker(Landroid/view/View;Landroid/text/Editable;CZI)Z
    ...
    .prologue
    sget-object v2, Landroid/text/method/QwertyKeyListener;->PICKER_SETS:Landroid/util/SparseArray;
    ...
    .local v11, set:Ljava/lang/String;
    const/4 v2, 0x1
    ...
    .local v6, smileDisplay:[Ljava/lang/String;
    new-instance v2, Landroid/text/method/SmilePickerDialog;
    ...
    invoke-direct/range {v2 .. v7}, Landroid/text/method/SmilePickerDialog;-><init>(Landroid/content/Context;Landroid/view/View;Landroid/text/Editable;[Ljava/lang/String;Z)V

    invoke-virtual {v2}, Landroid/text/method/SmilePickerDialog;->show()V

    const/4 v2, 0x1

    .end local v6           #smileDisplay:[Ljava/lang/String;
    :goto_0
    return v2
    ...
    invoke-direct/range {v7 .. v12}, Landroid/text/method/CharacterPickerDialog;-><init>(Landroid/content/Context;Landroid/view/View;Landroid/text/Editable;Ljava/lang/String;Z)V
