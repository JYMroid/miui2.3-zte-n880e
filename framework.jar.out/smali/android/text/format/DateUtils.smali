...
.method public static getSmallTimeString(Landroid/content/Context;ZF)Ljava/lang/CharSequence;
    ...
    .local v3, format_flags:I
    const-string v0, ""

    .local v0, timeString:Ljava/lang/String;
    const-string v0, ""

    .local v0, subTimeSting:Ljava/lang/String;
    const v0, 0xef00
    ...
    .local p0, subTimeSting:Ljava/lang/String;
    move-object v7, p0

    .end local p0           #subTimeSting:Ljava/lang/String;
    .local v7, subTimeSting:Ljava/lang/String;
    move p0, v0

    .end local v0           #format_flags:I
    .local p0, format_flags:I
    move-object v0, v1
    ...
    .end local v7           #subTimeSting:Ljava/lang/String;
    .local v1, subTimeSting:Ljava/lang/String;
    :goto_0
    if-eqz p1, :cond_6
    ...
    .local p0, formatted:Landroid/text/SpannableStringBuilder;
    new-instance v1, Landroid/text/style/RelativeSizeSpan;

    .end local v1           #subTimeSting:Ljava/lang/String;
    invoke-direct {v1, p2}, Landroid/text/style/RelativeSizeSpan;-><init>(F)V

    const/16 p2, 0x22

    invoke-virtual {p0, v1, p1, v0, p2}, Landroid/text/SpannableStringBuilder;->setSpan(Ljava/lang/Object;III)V

    .end local p2
    add-int/lit8 p2, v0, 0x1

    invoke-virtual {p0, v0, p2}, Landroid/text/SpannableStringBuilder;->delete(II)Landroid/text/SpannableStringBuilder;

    add-int/lit8 p2, p1, 0x1

    invoke-virtual {p0, p1, p2}, Landroid/text/SpannableStringBuilder;->delete(II)Landroid/text/SpannableStringBuilder;

    .end local v0           #magic2:I
    .end local p0           #formatted:Landroid/text/SpannableStringBuilder;
    .end local p1           #magic1:I
    :goto_1
    return-object p0

    .local v0, calendar:Ljava/util/Calendar;
    .local v1, currntTime:J
    .restart local v3       #format_flags:I
    .local p0, context:Landroid/content/Context;
    .local p1, wantAMPM:Z
    .restart local p2
    :cond_0
    ...
    .local v4, subTimeSting:Ljava/lang/String;
    invoke-virtual {v5}, Ljava/lang/String;->length()I

    move-result v2

    .end local v1           #currntTime:J
    .local v2, length:I
    if-lez v2, :cond_8
    ...
    invoke-virtual {v5, p0, v1}, Ljava/lang/String;->substring(II)Ljava/lang/String;

    .end local v1           #i:I
    .end local p0           #c:C
    move-result-object p0

    .end local v4           #subTimeSting:Ljava/lang/String;
    .local p0, subTimeSting:Ljava/lang/String;
    :goto_3
    if-eqz p1, :cond_7
    ...
    .local v1, timeStringBuffer:Ljava/lang/StringBuffer;
    const-string p0, " "
    ...
    .restart local p0       #subTimeSting:Ljava/lang/String;
    move-object v1, p0
    ...
    .local v1, i:I
    .restart local v3       #format_flags:I
    .restart local v4       #subTimeSting:Ljava/lang/String;
    ...
    .restart local v5       #timeString:Ljava/lang/String;
    .local p0, subTimeSting:Ljava/lang/String;
    .restart local p1       #wantAMPM:Z
    :cond_7
    move-object v1, p0

    .end local p0           #subTimeSting:Ljava/lang/String;
    .restart local v1       #subTimeSting:Ljava/lang/String;
    move-object v0, v5
