...
.field static final TRANSACTION_authorizeService:I = 0x26

.field static final TRANSACTION_cancelBondProcess:I = 0x13

.field static final TRANSACTION_cancelDiscovery:I = 0xe

.field static final TRANSACTION_cancelPairingUserInput:I = 0x25
...
.field static final TRANSACTION_deregisterCharacteristicsWatcher:I = 0x3f

.field static final TRANSACTION_deregisterEl2capConnection:I = 0x36

.field static final TRANSACTION_disable:I = 0x4

.field static final TRANSACTION_disconnectHeadset:I = 0x2e

.field static final TRANSACTION_disconnectSap:I = 0x40

.field static final TRANSACTION_discoverCharacteristics:I = 0x3c

.field static final TRANSACTION_enable:I = 0x3

.field static final TRANSACTION_fetchRemoteDiInfo:I = 0x31

.field static final TRANSACTION_fetchRemoteUuids:I = 0x1d

.field static final TRANSACTION_generateOobKeys:I = 0x32
...
.field static final TRANSACTION_getCharacteristicProperties:I = 0x3d

.field static final TRANSACTION_getDeviceBlockedState:I = 0x34

.field static final TRANSACTION_getDiscoverableTimeout:I = 0xb

.field static final TRANSACTION_getEffectiveAmpPolicy:I = 0x37

.field static final TRANSACTION_getGattServiceName:I = 0x3b

.field static final TRANSACTION_getGattServices:I = 0x3a

.field static final TRANSACTION_getName:I = 0x6

.field static final TRANSACTION_getRemoteClass:I = 0x1b

.field static final TRANSACTION_getRemoteFeature:I = 0x20

.field static final TRANSACTION_getRemoteL2capPsm:I = 0x1f

.field static final TRANSACTION_getRemoteName:I = 0x19

.field static final TRANSACTION_getRemoteServiceChannel:I = 0x1e

.field static final TRANSACTION_getRemoteServices:I = 0x30
...
.field static final TRANSACTION_registerCharacteristicsWatcher:I = 0x3e

.field static final TRANSACTION_registerEl2capConnection:I = 0x35

.field static final TRANSACTION_removeBond:I = 0x14

.field static final TRANSACTION_removeServiceRecord:I = 0x2c

.field static final TRANSACTION_setBluetoothClass:I = 0x18

.field static final TRANSACTION_setDesiredAmpPolicy:I = 0x38

.field static final TRANSACTION_setDeviceBlockedState:I = 0x33
...
.field static final TRANSACTION_setRemoteOutOfBandData:I = 0x24

.field static final TRANSACTION_setScanMode:I = 0xa

.field static final TRANSACTION_setServiceTrust:I = 0x28

.field static final TRANSACTION_setTrust:I = 0x27

.field static final TRANSACTION_setUseWifiForBtTransfers:I = 0x39
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .local v1, _arg1:I
    invoke-virtual {p0, v0, v1}, Landroid/bluetooth/IBluetooth$Stub;->setBluetoothClass(Ljava/lang/String;I)Z
    ...
    .restart local v1       #_arg1:Landroid/os/ParcelUuid;
    :goto_14
    invoke-virtual {p0, v0, v1}, Landroid/bluetooth/IBluetooth$Stub;->getRemoteL2capPsm(Ljava/lang/String;Landroid/os/ParcelUuid;)I
    ...
    invoke-virtual {p0, v0, v1}, Landroid/bluetooth/IBluetooth$Stub;->getRemoteFeature(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, v1}, Landroid/bluetooth/IBluetooth$Stub;->registerEl2capConnection(Landroid/bluetooth/IBluetoothCallback;I)I
    ...
    .local v0, _arg0:I
    invoke-virtual {p0, v0}, Landroid/bluetooth/IBluetooth$Stub;->deregisterEl2capConnection(I)V
    ...
    .restart local v0       #_arg0:I
    invoke-virtual {p0, v0}, Landroid/bluetooth/IBluetooth$Stub;->getEffectiveAmpPolicy(I)I
    ...
    .restart local v1       #_arg1:I
    invoke-virtual {p0, v0, v1}, Landroid/bluetooth/IBluetooth$Stub;->setDesiredAmpPolicy(II)Z
    ...
    .local v0, _arg0:Z
    :goto_2b
    invoke-virtual {p0, v0}, Landroid/bluetooth/IBluetooth$Stub;->setUseWifiForBtTransfers(Z)V
    ...
    .local v1, _arg1:Landroid/os/ParcelUuid;
    :goto_2c
    invoke-virtual {p0, v0, v1}, Landroid/bluetooth/IBluetooth$Stub;->getGattServices(Ljava/lang/String;Landroid/os/ParcelUuid;)Z
    ...
    .restart local v0       #_arg0:Ljava/lang/String;
    invoke-virtual {p0, v0}, Landroid/bluetooth/IBluetooth$Stub;->getGattServiceName(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v5}, Landroid/bluetooth/IBluetoothGattService$Stub;->asInterface(Landroid/os/IBinder;)Landroid/bluetooth/IBluetoothGattService;

    move-result-object v1

    .local v1, _arg1:Landroid/bluetooth/IBluetoothGattService;
    invoke-virtual {p0, v0, v1}, Landroid/bluetooth/IBluetooth$Stub;->discoverCharacteristics(Ljava/lang/String;Landroid/bluetooth/IBluetoothGattService;)Z
    ...
    .end local v0           #_arg0:Ljava/lang/String;
    .end local v1           #_arg1:Landroid/bluetooth/IBluetoothGattService;
    .end local v4           #_result:Z
    :sswitch_3d
    const-string v5, "android.bluetooth.IBluetooth"
    ...
    .restart local v0       #_arg0:Ljava/lang/String;
    invoke-virtual {p0, v0}, Landroid/bluetooth/IBluetooth$Stub;->getCharacteristicProperties(Ljava/lang/String;)[Ljava/lang/String;
    ...
    .restart local v0       #_arg0:Ljava/lang/String;
    invoke-virtual {p0, v0}, Landroid/bluetooth/IBluetooth$Stub;->registerCharacteristicsWatcher(Ljava/lang/String;)Z
    ...
    .restart local v0       #_arg0:Ljava/lang/String;
    invoke-virtual {p0, v0}, Landroid/bluetooth/IBluetooth$Stub;->deregisterCharacteristicsWatcher(Ljava/lang/String;)Z
