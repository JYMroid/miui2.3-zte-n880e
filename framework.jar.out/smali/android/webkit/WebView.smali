...
.field public static final SCHEME_MMS:Ljava/lang/String; = "mms:"

.field public static final SCHEME_MMSTO:Ljava/lang/String; = "mmsto:"
...
.field private mAddressCacheMonitor:Landroid/webkit/AddressCacheMonitor;
...
.method protected constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;ILjava/util/Map;)V
    ...
    iput v2, p0, Landroid/webkit/WebView;->PIVOT_X_VALUE:F

    iput v2, p0, Landroid/webkit/WebView;->PIVOT_Y_VALUE:F
    ...
    invoke-static {p1}, Landroid/webkit/AddressCacheMonitor;->getAddressCacheMonitor(Landroid/content/Context;)Landroid/webkit/AddressCacheMonitor;

    move-result-object v2

    iput-object v2, p0, Landroid/webkit/WebView;->mAddressCacheMonitor:Landroid/webkit/AddressCacheMonitor;
...
.method private doFling()V
    ...
    .restart local v13       #circle:F
    .restart local v15       #deltaR:F
    :cond_10
    const-string v2, "webview"
...
.method private hitFocusedPlugin(II)Z
    ...
    const-string v2, "nativeFocusIsPlugin()="
    ...
    const-string v2, "nativeFocusNodeBounds()=("
...
.method private navHandledKey(IIZJ)Z
    ...
    const-string v13, "navHandledKey mLastCursorBounds="
    ...
    const-string v13, "navHandledKey contentCursorRingBounds="
...
.method private sendOurVisibleRect()Landroid/graphics/Rect;
    ...
    const-string v5, "sendOurVisibleRect=("
...
.method moveSelection(FF)V
    ...
    const-string v9, "moveSelection mSelectX="
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .local v3, preRotateWidth:I
    invoke-virtual {v0}, Landroid/view/Display;->getHeight()I

    move-result v2

    .local v2, preRotateHeight:I
    invoke-virtual {v0}, Landroid/view/Display;->getRotation()I
    ...
    iget v4, p0, Landroid/webkit/WebView;->mOrientation:I

    if-eq v1, v4, :cond_0

    iput v1, p0, Landroid/webkit/WebView;->mOrientation:I
...
.method protected onFocusChanged(ZILandroid/graphics/Rect;)V
    ...
    invoke-direct {p0, v4, v3, v4}, Landroid/webkit/WebView;->nativeRecordButtons(ZZZ)V
    ...
    invoke-direct {p0, v3, v3, v4}, Landroid/webkit/WebView;->nativeRecordButtons(ZZZ)V

    :cond_2
    invoke-virtual {p0}, Landroid/webkit/WebView;->setFocusControllerInactive()V

    :cond_3
    iput-boolean v3, p0, Landroid/webkit/WebView;->mGotKeyDown:Z
...
.method public onTrackballEvent(Landroid/view/MotionEvent;)Z
    ...
    const-string v3, "onTrackballEvent down ev="
    ...
    const-string v3, "onTrackballEvent up ev="
    ...
    const-string v2, "onTrackballEvent gmail quit"
    ...
    const-string v2, "onTrackballEvent down quit"
    ...
    const-string v2, "onTrackballEvent up timeout quit"
    ...
    const-string v3, "onTrackballEvent time="
    ...
    const-string v3, "onTrackballEvent ev="
...
.method rebuildWebTextView()V
    ...
    const-string v9, "rebuildWebTextView null == text"
...
.method public setFindDialogHeight(I)V
    ...
    const-string v2, "setFindDialogHeight height="
