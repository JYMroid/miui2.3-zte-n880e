...
.field private static final HTTP_BAD_GATEWAY:I = 0x1f6
...
.field private static final HTTP_GATEWAY_TIMEOUT:I = 0x1f8

.field private static final HTTP_INTERNAL_SERERROR:I = 0x1f4

.field private static final HTTP_MOVED_PERMANENTLY:I = 0x12d

.field private static final HTTP_NOT_ACCEPTABLE:I = 0x196
...
.field private static final HTTP_SERVICE_UNAVAIL:I = 0x1f7
...
.method private guessMimeType()V
    ...
    iget-object v3, p0, Landroid/webkit/LoadListener;->mContext:Landroid/content/Context;
    ...
    invoke-direct {p0, v3, v2}, Landroid/webkit/LoadListener;->handleError(ILjava/lang/String;)V
    ...
    invoke-direct {p0, v3}, Landroid/webkit/LoadListener;->guessMimeTypeFromExtension(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    .local v1, newMimeType:Ljava/lang/String;
    if-eqz v1, :cond_2
    ...
    invoke-direct {p0, v0}, Landroid/webkit/LoadListener;->shouldDownloadByExtension(Ljava/lang/String;)Z
    ...
    const-string v3, "LoadListener"

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "the site extension is "
...
.method private handleEndData()V
    ...
    invoke-static {p0, v0, v2, v3, v4}, Landroid/webkit/HttpAuthHandler;->onReceivedCredentials(Landroid/webkit/LoadListener;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-boolean v2, p0, Landroid/webkit/LoadListener;->mIsMainResourceLoader:Z
    ...
    const-string v2, "http://search.about.com"
    ...
    const-string v4, "403 Forbidden"

    const-string v5, ""

    invoke-virtual {v2, v3, v4, v5}, Landroid/webkit/BrowserFrame;->reportError(ILjava/lang/String;Ljava/lang/String;)V
    ...
    const-string v3, "502 Bad Gateway"
    ...
    const-string v3, "504 Gateway Timeout"
    ...
    const-string v3, "406 Not Acceptable"
...
.method private shouldDownloadByExtension(Ljava/lang/String;)Z
    .locals 1
    .parameter "extension"
...
.method static willLoadFromCache(Ljava/lang/String;J)Z
    ...
    const-string v3, "willLoadFromCache: "
