...
.method private loadParts(J)[Lcom/google/android/mms/pdu/PduPart;
    ...
    invoke-static/range {v34 .. v34}, Lcom/google/android/mms/ContentType;->isVcardType(Ljava/lang/String;)Z
...
.method private updatePart(Landroid/net/Uri;Lcom/google/android/mms/pdu/PduPart;)V
    ...
    const-string v1, "persistPart:fileName = "
    ...
    const-string v1, "persistPart:name = "
...
.method public load(Landroid/net/Uri;)Lcom/google/android/mms/pdu/GenericPdu;
    ...
    invoke-direct {v0, v1}, Lcom/google/android/mms/pdu/WapPushPdu;-><init>(Lcom/google/android/mms/pdu/PduHeaders;)V
...
.method public persist(Lcom/google/android/mms/pdu/GenericPdu;Landroid/net/Uri;)Landroid/net/Uri;
    ...
    invoke-static {v0, v1, v2, v3}, Landroid/provider/Telephony$Threads;->getOrCreateThreadId(Landroid/content/Context;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;)J
    ...
    const-string v5, "recipient_cc_ids"

    const-string v6, ""

    invoke-virtual {v8, v5, v6}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/String;)V

    const-string v5, "recipient_bcc_ids"
...
.method public persistPart(Lcom/google/android/mms/pdu/PduPart;J)Landroid/net/Uri;
    ...
    const-string v9, "persistPart:fileName = "
    ...
    const-string v9, "persistPart:name = "
...
.method public updateHeaders(Landroid/net/Uri;Lcom/google/android/mms/pdu/SendReq;)V
    ...
    .local v42, uriBuilder:Landroid/net/Uri$Builder;
    new-instance v8, Landroid/content/ContentValues;
    ...
    .local v17, cc_recipients:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    new-instance v15, Ljava/util/HashSet;

    invoke-direct {v15}, Ljava/util/HashSet;-><init>()V

    .local v15, bcc_recipients:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    ...
    .end local v13           #arr$:[Lcom/google/android/mms/pdu/EncodedStringValue;
    .end local v14           #array:[Lcom/google/android/mms/pdu/EncodedStringValue;
    .end local v15           #bcc_recipients:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    .end local v17           #cc_recipients:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    .end local v25           #headers:Lcom/google/android/mms/pdu/PduHeaders;
    .end local v26           #i$:I
    .end local v29           #len$:I
    .end local v30           #messageSize:J
    .end local v33           #msgId:J
    ...
    .restart local v11       #addrType:I
    .restart local v14       #array:[Lcom/google/android/mms/pdu/EncodedStringValue;
    .restart local v15       #bcc_recipients:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    .restart local v17       #cc_recipients:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    ...
    .local v18, ccrecipient:Ljava/lang/String;
    invoke-static/range {v18 .. v18}, Landroid/provider/Telephony$Mms;->isEmailAddress(Ljava/lang/String;)Z

    move-result v5

    if-eqz v5, :cond_13

    invoke-static/range {v18 .. v18}, Landroid/provider/Telephony$Mms;->extractAddrSpec(Ljava/lang/String;)Ljava/lang/String;
    ...
    .end local v18           #ccrecipient:Ljava/lang/String;
    ...
    .local v16, bccrecipient:Ljava/lang/String;
    ...
    .end local v16           #bccrecipient:Ljava/lang/String;
    .end local v26           #i$:Ljava/util/Iterator;
    :cond_16
    ...
    .local v7, hduri:Landroid/net/Uri;
    move-object/from16 v0, p0
...
.method public updateParts(Landroid/net/Uri;Lcom/google/android/mms/pdu/PduBody;)V
    ...
    .local v13, toBeCreated:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/google/android/mms/pdu/PduPart;>;"
    new-instance v14, Ljava/util/HashMap;

    invoke-direct {v14}, Ljava/util/HashMap;-><init>()V

    .local v14, toBeUpdated:Ljava/util/HashMap;,"Ljava/util/HashMap<Landroid/net/Uri;Lcom/google/android/mms/pdu/PduPart;>;"
    ...
    .local v5, filter:Ljava/lang/StringBuilder;
    const/4 v6, 0x0
    ...
    invoke-static {v5, v15}, Landroid/database/DatabaseUtils;->appendEscapedSQLString(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    invoke-static/range {v15 .. v19}, Lcom/google/android/mms/util/SqliteWrapper;->delete(Landroid/content/Context;Landroid/content/ContentResolver;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    check-cast v10, Lcom/google/android/mms/pdu/PduPart;
    ...
    .local v4, e:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Landroid/net/Uri;Lcom/google/android/mms/pdu/PduPart;>;"
    ...
    .end local v4           #e:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Landroid/net/Uri;Lcom/google/android/mms/pdu/PduPart;>;"
    :cond_6
    return-void
.end method
