...
.field private static final lookupForGsmAsciii:[I
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/internal/location/GpsNetInitiatedHandler;->lookupForGsmAsciii:[I
...
.method static convertGsmIntoAscii([B)[B
    .locals 7
    .parameter "input"
    ...
    const-string v4, "Received null input for convertGsmIntoAscii() function"
    ...
    .local v3, stringBuf:[B
    const/4 v2, 0x0

    .local v2, nStringIndex:I
    const/4 v0, 0x0

    .local v0, nInputIndex:I
    :goto_1
    array-length v4, p0

    if-ge v0, v4, :cond_3

    sget-object v4, Lcom/android/internal/location/GpsNetInitiatedHandler;->lookupForGsmAsciii:[I

    add-int/lit8 v1, v0, 0x1

    .end local v0           #nInputIndex:I
    .local v1, nInputIndex:I
    aget-byte v5, p0, v0
    ...
    const-string v4, "The input is malformed with ESC as last char. Aborting"
    ...
    .end local v1           #nInputIndex:I
    .restart local v0       #nInputIndex:I
    goto :goto_1

    .end local v0           #nInputIndex:I
    .restart local v1       #nInputIndex:I
    :sswitch_0
    const/16 v4, 0xc
...
.method static decodeGSMPackedString([B)Ljava/lang/String;
    ...
    .local v9, stringBuf:[B
    const-string v8, ""

    .local v8, result:Ljava/lang/String;
    const/4 v4, 0x0

    .local v4, numOfEscapeChars:I
    move v6, v4

    .end local v4           #numOfEscapeChars:I
    .local v6, numOfEscapeChars:I
    move v5, v3
    ...
    .end local v6           #numOfEscapeChars:I
    .local v5, numOfEscapeChars:I
    :goto_1
    const/4 v6, 0x6
    ...
    .end local v5           #numOfEscapeChars:I
    .local v2, numOfEscapeChars:I
    :goto_2
    invoke-static {v9}, Lcom/android/internal/location/GpsNetInitiatedHandler;->convertGsmIntoAscii([B)[B

    move-result-object v0

    .local v0, resultIntermediate:[B
    :try_start_0
    ...
    .end local v2           #numOfEscapeChars:I
    invoke-direct {p0, v0, v3, v1, v2}, Ljava/lang/String;-><init>([BIILjava/lang/String;)V
    :try_end_0
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_0 .. :try_end_0} :catch_0

    .end local v0           #resultIntermediate:[B
    ...
    .local v0, cCurr:I
    .restart local v1       #nStridx:I
    .local v2, nPckidx:I
    .restart local v5       #numOfEscapeChars:I
    ...
    .end local v5           #numOfEscapeChars:I
    .restart local v6       #numOfEscapeChars:I
    move v5, v3
