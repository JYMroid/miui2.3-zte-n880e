...
.method readHistory(Landroid/os/Parcel;)V
    ...
    iput-object v8, p0, Lcom/android/internal/os/BatteryStatsImpl;->mHistoryCache:Landroid/os/BatteryStats$HistoryItem;

    iput-object v8, p0, Lcom/android/internal/os/BatteryStatsImpl;->mHistoryEnd:Landroid/os/BatteryStats$HistoryItem;

    iput-object v8, p0, Lcom/android/internal/os/BatteryStatsImpl;->mHistory:Landroid/os/BatteryStats$HistoryItem;

    const-wide/16 v8, 0x0

    iput-wide v8, p0, Lcom/android/internal/os/BatteryStatsImpl;->mHistoryBaseTime:J

    invoke-virtual {p1}, Landroid/os/Parcel;->dataAvail()I

    move-result v2

    .local v2, oldDataAvail:I
    const/4 v1, 0x0

    .local v1, newDataAvail:I
    :cond_0
    :goto_0
    ...
    const-string v10, "RMS: Error reading battery statistics: newDataAvail "
    ...
    const-string v8, "/data/system/batterystats.bin"

    invoke-direct {v0, v8}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    .local v0, batterystats:Ljava/io/File;
    invoke-virtual {v0}, Ljava/io/File;->exists()Z
    ...
    const-string v9, "remove the file"

    invoke-static {v8, v9}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/String;)I

    invoke-virtual {v0}, Ljava/io/File;->delete()Z

    .end local v0           #batterystats:Ljava/io/File;
    :cond_2
    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J
    ...
    iget-wide v8, p0, Lcom/android/internal/os/BatteryStatsImpl;->mHistoryBaseTime:J
    ...
    .end local v3           #oldnow:J
    :cond_4
    move v2, v1

    new-instance v5, Landroid/os/BatteryStats$HistoryItem;

    invoke-direct {v5, v6, v7, p1}, Landroid/os/BatteryStats$HistoryItem;-><init>(JLandroid/os/Parcel;)V

    .local v5, rec:Landroid/os/BatteryStats$HistoryItem;
    invoke-virtual {p0, v5}, Lcom/android/internal/os/BatteryStatsImpl;->addHistoryRecordLocked(Landroid/os/BatteryStats$HistoryItem;)V
