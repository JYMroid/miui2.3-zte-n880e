...
.method public equals(Ljava/lang/Object;)Z
    ...
    .prologue
    instance-of v2, p1, Lcom/android/internal/telephony/GsmSMSDispatcher$SmsCbConcatInfo;
    ...
    .local v1, other:Lcom/android/internal/telephony/GsmSMSDispatcher$SmsCbConcatInfo;
    iget-object v2, p0, Lcom/android/internal/telephony/GsmSMSDispatcher$SmsCbConcatInfo;->mHeader:Lcom/android/internal/telephony/gsm/SmsCbHeader;

    iget v2, v2, Lcom/android/internal/telephony/gsm/SmsCbHeader;->geographicalScope:I

    iget-object v3, v1, Lcom/android/internal/telephony/GsmSMSDispatcher$SmsCbConcatInfo;->mHeader:Lcom/android/internal/telephony/gsm/SmsCbHeader;
    ...
    iget-object v2, v1, Lcom/android/internal/telephony/GsmSMSDispatcher$SmsCbConcatInfo;->mPlmn:Ljava/lang/String;

    iget v3, v1, Lcom/android/internal/telephony/GsmSMSDispatcher$SmsCbConcatInfo;->mLac:I

    iget v4, v1, Lcom/android/internal/telephony/GsmSMSDispatcher$SmsCbConcatInfo;->mCid:I

    invoke-virtual {p0, v2, v3, v4}, Lcom/android/internal/telephony/GsmSMSDispatcher$SmsCbConcatInfo;->matchesLocation(Ljava/lang/String;II)Z

    move-result v2

    .end local v1           #other:Lcom/android/internal/telephony/GsmSMSDispatcher$SmsCbConcatInfo;
    :goto_0
    return v2
...
.method public matchesLocation(Ljava/lang/String;II)Z
    ...
    :pswitch_0
    iget v0, p0, Lcom/android/internal/telephony/GsmSMSDispatcher$SmsCbConcatInfo;->mCid:I
    ...
    :cond_0
    :pswitch_1
    iget v0, p0, Lcom/android/internal/telephony/GsmSMSDispatcher$SmsCbConcatInfo;->mLac:I
    ...
    :cond_1
    :pswitch_2
    iget-object v0, p0, Lcom/android/internal/telephony/GsmSMSDispatcher$SmsCbConcatInfo;->mPlmn:Ljava/lang/String;
