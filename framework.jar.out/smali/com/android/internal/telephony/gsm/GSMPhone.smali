...
.field public mVmNumGsmKey:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;Lcom/android/internal/telephony/PhoneNotifier;ZLcom/android/internal/telephony/DataConnectionTracker;I)V
    ...
    iput-object v2, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mVmNumGsmKey:Ljava/lang/String;

    iput-object v2, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mVmCountKey:Ljava/lang/String;

    iput-object v2, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mVmSimImsiKey:Ljava/lang/String;

    iput-object v2, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mCfEnabledKey:Ljava/lang/String;

    iput-object v2, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mSubscriptionData:Lcom/android/internal/telephony/ProxyManager$Subscription;

    const/4 v0, 0x0

    iput v0, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mSubscription:I
    ...
    iput p6, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mSubscription:I
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mVmCountKey:Ljava/lang/String;
    ...
    invoke-direct {p0}, Lcom/android/internal/telephony/gsm/GSMPhone;->setProperties()V
...
.method private getCallForwardingPreference()Z
    ...
    iget-object v2, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mCfEnabledKey:Ljava/lang/String;
...
.method private getStoredVoiceMessageCount()I
    ...
    iget v6, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mSubscription:I
    ...
    .local v4, vm_id:Ljava/lang/String;
    const/4 v5, 0x0
...
.method private getVmSimImsi()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mVmSimImsiKey:Ljava/lang/String;
...
.method private handleSetSelectNetwork(Landroid/os/AsyncResult;)V
    ...
    const-string v4, "Writing NETWORK_SELECTION_KEY "
    ...
    const-string v4, "Writing NETWORK_SELECTION_NAME_KEY "
...
.method private onIncomingUSSD(ILjava/lang/String;)V
    ...
    const-string v7, "onIncomingUSSD: isrequest="
    ...
    const-string v7, "onIncomingUSSD: penging="
    ...
    invoke-virtual {v6}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->getState()Lcom/android/internal/telephony/MmiCode$State;
    ...
    const-string v7, "onIncomingUSSD: found, nw init flag="

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    invoke-virtual {v0}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->isFirstNeInitiated()Z
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->resetNwInitiatedFlag()V
    ...
    const-string v6, "onIncomingUSSD: Not found, new NW init ussd "
...
.method private setProperties()V
    ...
    iget v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mSubscription:I
...
.method private setVmSimImsi(Ljava/lang/String;)V
    ...
    .local v0, editor:Landroid/content/SharedPreferences$Editor;
    iget-object v2, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mVmSimImsiKey:Ljava/lang/String;
...
.method private updateCallForwardStatus(I)V
    ...
    const-string v1, "updateCallForwardStatus got sim records"
...
.method public getCellBroadcastSmsConfig(Landroid/os/Message;)V
    ...
    .prologue
    const-string v0, "GSMPhone.java"

    const-string v1, "shen getCellBroadcastSmsConfig()"
...
.method public getServiceState()Landroid/telephony/ServiceState;
    ...
    iget v2, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mSubscription:I
...
.method public getSubscription()I
    ...
    .prologue
    iget v0, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mSubscription:I
...
.method public getSubscriptionInfo()Lcom/android/internal/telephony/ProxyManager$Subscription;
    ...
    .prologue
    iget-object v0, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mSubscriptionData:Lcom/android/internal/telephony/ProxyManager$Subscription;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :goto_3
    invoke-virtual/range {v17 .. v19}, Lcom/android/internal/telephony/gsm/SIMRecords;->setVoiceCallForwardingFlag(IZ)V
    ...
    const-string v18, "setVoiceCallForwardingFlag() aborted. icc absent?"

    invoke-static/range {v17 .. v18}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I

    new-instance v17, Ljava/lang/RuntimeException;

    const-string v18, "Sim card is absent."
    ...
    .local v7, eonsNetworkNames:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/gsm/NetworkInfo;>;"
    move-object/from16 v0, p1
    ...
    const-string v18, "getEonsAvailableNetworks() aborted. icc absent?"
    ...
    const-string v18, "[EONS] Populated EONS for available networks."
    ...
    .end local v7           #eonsNetworkNames:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/gsm/NetworkInfo;>;"
    check-cast v7, Ljava/util/ArrayList;

    .restart local v7       #eonsNetworkNames:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/gsm/NetworkInfo;>;"
    goto :goto_4
    ...
    const-string v18, "Error while fetching Mdn"
    ...
    const-string v18, "EVENT_SUBSCRIPTION_STATUS_CHANGED"
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->m3gppApplication:Lcom/android/internal/telephony/UiccCardApplication;
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/internal/telephony/gsm/GsmMmiCode;-><init>(Lcom/android/internal/telephony/gsm/GSMPhone;Lcom/android/internal/telephony/UiccCardApplication;)V
...
.method public isCspPlmnEnabled()Z
    ...
    const-string v1, "isCspPlmnEnabled(), mSIMRecords is null."
...
.method notifyDataNationRoamingP(Z)V
    .locals 0
    .parameter "hasRoaming"

    .prologue
    invoke-super {p0, p1}, Lcom/android/internal/telephony/PhoneBase;->notifyDataNationRoaming(Z)V
...
.method onMMIDone(Lcom/android/internal/telephony/gsm/GsmMmiCode;)V
    ...
    const-string v2, "onMMIDone: leave, now pending size="
...
.method public resetSubSpecifics()V
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mImei:Ljava/lang/String;

    iput-object v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mImeiSv:Ljava/lang/String;
    ...
    :goto_0
    iget-object v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->notificationManager:Landroid/app/NotificationManager;
    ...
    invoke-virtual {p0, v1}, Lcom/android/internal/telephony/gsm/GSMPhone;->setVoiceMessageCount(I)V
...
.method public setCellBroadcastSmsConfig([ILandroid/os/Message;)V
    ...
    const-string v1, "shen setCellBroadcastSmsConfig()"

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v0, p0, Lcom/android/internal/telephony/PhoneBase;->mCM:Lcom/android/internal/telephony/CommandsInterface;

    invoke-interface {v0, p1, p2}, Lcom/android/internal/telephony/CommandsInterface;->setGsmBroadcastConfig([ILandroid/os/Message;)V
...
.method public setNetworkSelectionModeAutomatic(Landroid/os/Message;)V
    ...
    iput-object v4, v1, Lcom/android/internal/telephony/gsm/GSMPhone$NetworkSelectMessage;->operatorNumeric:Ljava/lang/String;

    const-string v2, ""

    iput-object v4, v1, Lcom/android/internal/telephony/gsm/GSMPhone$NetworkSelectMessage;->operatorAlphaLong:Ljava/lang/String;
    ...
    const-string v2, "Posting EVENT_SET_NETWORK_AUTOMATIC_COMPLETE internally "
...
.method public setSubscription(I)V
    ...
    .prologue
    iput p1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mSubscription:I
...
.method public setSubscriptionInfo(Lcom/android/internal/telephony/ProxyManager$Subscription;)V
    ...
    .prologue
    iput-object p1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mSubscriptionData:Lcom/android/internal/telephony/ProxyManager$Subscription;

    iget-object v0, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mSubscriptionData:Lcom/android/internal/telephony/ProxyManager$Subscription;

    iget v0, v0, Lcom/android/internal/telephony/ProxyManager$Subscription;->subId:I

    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/gsm/GSMPhone;->setSubscription(I)V
    ...
    iget-object v2, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mSubscriptionData:Lcom/android/internal/telephony/ProxyManager$Subscription;
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/android/internal/telephony/gsm/GSMPhone;->updateIccAvailability()V

    iget-object v0, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mSST:Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;

    invoke-virtual {v0}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->updateRecords()V
...
.method updateIccAvailability()V
    ...
    iget-object v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mSubscriptionData:Lcom/android/internal/telephony/ProxyManager$Subscription;
    ...
    iget-object v3, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mSubscriptionData:Lcom/android/internal/telephony/ProxyManager$Subscription;
    ...
    iput-object v4, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mSIMRecords:Lcom/android/internal/telephony/gsm/SIMRecords;

    iget-object v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mSimPhoneBookIntManager:Lcom/android/internal/telephony/gsm/SimPhoneBookInterfaceManager;

    invoke-virtual {v1, v4}, Lcom/android/internal/telephony/gsm/SimPhoneBookInterfaceManager;->updateSimRecords(Lcom/android/internal/telephony/gsm/SIMRecords;)V
    ...
    iput-object v4, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->m3gppApplication:Lcom/android/internal/telephony/UiccCardApplication;

    iput-object v4, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mSimCard:Lcom/android/internal/telephony/UiccCard;
