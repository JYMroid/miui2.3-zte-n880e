...
# static fields
.field static final DATETIME_TIMEZONE_SETTING:I = 0x3
...
.field static final NON_SPECIFIC_LANG_NOTIFICATION:I = 0x0
...
.field static final SPECIFIC_LANG_NOTIFICATION:I = 0x1
...
.method private constructor <init>(Lcom/android/internal/telephony/cat/RilMessageDecoder;)V
    ...
    iput-object v4, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->mCaller:Lcom/android/internal/telephony/cat/RilMessageDecoder;

    iput-boolean v5, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->mloadIcon:Z

    const-string v4, ""

    iput-object v4, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->defaultLang:Ljava/lang/String;
    ...
    const-string v4, "persist.radio.gcftest"
    ...
    .local v3, localetmp:Ljava/util/Locale;
    ...
    const-string v5, "default language: "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-object v5, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->defaultLang:Ljava/lang/String;
    ...
    .end local v3           #localetmp:Ljava/util/Locale;
    :cond_0
    :goto_0
    return-void
    ...
    const-string v4, "getLanguage error"
...
.method static declared-synchronized getInstance(Lcom/android/internal/telephony/cat/RilMessageDecoder;)Lcom/android/internal/telephony/cat/CommandParamsFactory;
    ...
    invoke-direct {v1, p0}, Lcom/android/internal/telephony/cat/CommandParamsFactory;-><init>(Lcom/android/internal/telephony/cat/RilMessageDecoder;)V
...
.method private processGetInput(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    const-string v12, ", truncating to "
...
.method private processLangNotification(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    .locals 8
    .parameter "cmdDet"
    .parameter
    .annotation system Ldalvik/annotation/Signature;
    ...
    const-string v5, "process LangNotification"
    ...
    const-string v6, "LANG_NOTIFICATION["
    ...
    :pswitch_0
    const-string v5, "NON_SPECIFIC_LANG_NOTIFICATION"
    ...
    iget-object v6, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->defaultLang:Ljava/lang/String;
    ...
    const-string v6, "set default languauge: "
    ...
    const-string v5, "set default languauge error"
    ...
    :pswitch_1
    const-string v5, "SPECIFIC_LANG_NOTIFICATION"
    ...
    invoke-static {v2}, Lcom/android/internal/telephony/cat/ValueParser;->retrieveLangString(Lcom/android/internal/telephony/cat/ComprehensionTlv;)Ljava/lang/String;
    ...
    const-string v5, "set languauge error"
...
.method private processSetupCall(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    :cond_0
    sget-object v8, Lcom/android/internal/telephony/cat/ComprehensionTlvTag;->ADDRESS_ID:Lcom/android/internal/telephony/cat/ComprehensionTlvTag;
...
.method make(Lcom/android/internal/telephony/cat/BerTlv;Lcom/android/internal/telephony/cat/IconLoader;)V
    ...
    invoke-direct {p0, v0, v3}, Lcom/android/internal/telephony/cat/CommandParamsFactory;->processLangNotification(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    :try_end_2
