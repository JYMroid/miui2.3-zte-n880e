...
.field cdmaLineCtrlDuration:J

.field cdmaLineCtrlTime:J

.field cdmaLineCtrlTimeReal:J
...
.method private doDisconnect()V
    ...
    iget-wide v0, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->cdmaLineCtrlTimeReal:J
    ...
    iget-wide v2, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->cdmaLineCtrlTimeReal:J

    sub-long/2addr v0, v2

    iput-wide v0, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->cdmaLineCtrlDuration:J
    ...
    const-string v2, "wsh : doDisconnect:cdmaLineCtrlDuration="

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-wide v2, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->cdmaLineCtrlDuration:J
...
.method private processPostDialChar(C)Z
    ...
    .local v0, dtmfChar:Ljava/lang/Character;
    invoke-virtual {v0}, Ljava/lang/Character;->toString()Ljava/lang/String;

    move-result-object v1

    .local v1, dtmfStr:Ljava/lang/String;
    ...
    invoke-interface {v2, v1, v4, v4, v3}, Lcom/android/internal/telephony/CommandsInterface;->sendBurstDtmf(Ljava/lang/String;IILandroid/os/Message;)V

    const-string v2, "CDMA"

    const-string v3, "CdmaConnection.processPostDialChar()"

    invoke-static {v2, v3}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I

    .end local v0           #dtmfChar:Ljava/lang/Character;
    .end local v1           #dtmfStr:Ljava/lang/String;
    :goto_0
    move v2, v6
    ...
    invoke-direct {p0, v2}, Lcom/android/internal/telephony/cdma/CdmaConnection;->setPostDialState(Lcom/android/internal/telephony/Connection$PostDialState;)V
...
.method public getCdmaLineCtrlDurationMillis()J
    ...
    iget-wide v4, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->cdmaLineCtrlTimeReal:J
    ...
    :cond_1
    iget-wide v0, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->cdmaLineCtrlDuration:J
...
.method onCdmaLineCtrlInfo()V
    ...
    const-string v0, "wsh : onCdmaLineCtrlInfo ->"
    ...
    iput-wide v0, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->cdmaLineCtrlTime:J

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J

    move-result-wide v0

    iput-wide v0, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->cdmaLineCtrlTimeReal:J
    ...
    const-string v1, "wsh : cdmaLineCtrlTime="

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-wide v1, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->cdmaLineCtrlTime:J

    invoke-virtual {v0, v1, v2}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    move-result-object v0

    const-string v1, ",cdmaLineCtrlTimeReal="

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-wide v1, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->cdmaLineCtrlTimeReal:J
...
.method update(Lcom/android/internal/telephony/DriverCall;)Z
    ...
    const-string v6, "wsh : CdmaConnection::update:newParent != parent"
