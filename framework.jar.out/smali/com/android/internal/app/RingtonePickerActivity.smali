...
.field private mExternalPos:I

.field private mExternalType:I

.field private mHandler:Landroid/os/Handler;

.field private mHasDefaultItem:Z

.field private mHasExternalItem:Z

.field private mHasSilentItem:Z

.field private mIsProfileMode:Z
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/android/internal/app/RingtonePickerActivity;->mExternalPos:I

    iput v0, p0, Lcom/android/internal/app/RingtonePickerActivity;->mExternalType:I

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/internal/app/RingtonePickerActivity;->mListView:Landroid/widget/ListView;
...
.method static synthetic access$000(Lcom/android/internal/app/RingtonePickerActivity;)I
    ...
    .prologue
    iget v0, p0, Lcom/android/internal/app/RingtonePickerActivity;->mExternalPos:I
...
.method private addExternalItem(Landroid/widget/ListView;I)I
    .locals 4
    .parameter "listView"
    .parameter "textResId"
...
.method FMStart()V
    ...
    const-string v2, "FMStart()"

    invoke-static {v1, v2}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    new-instance v0, Landroid/content/Intent;

    const-string v1, "zte.com.cn.fm.ACTION_RESUME"
...
.method FMStop()V
    ...
    const-string v2, "FMStop()"

    invoke-static {v1, v2}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    new-instance v0, Landroid/content/Intent;

    const-string v1, "zte.com.cn.fm.ACTION_PAUSE"
...
.method musicServiceStart()V
    .locals 3

    .prologue
    const-string v1, "RingtonePickerActivity"

    const-string v2, "musicServiceStart()"
    ...
    const-string v2, "cn.com.zte.music.resume"
...
.method musicServiceStop()V
    .locals 3

    .prologue
    const-string v1, "RingtonePickerActivity"

    const-string v2, "musicServiceStop()"
    ...
    const-string v2, "cn.com.zte.music.pause"
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    const-string v5, "Profile onActivityResult() requestCode =="
    ...
    const-string v5, "Profile onActivityResult() resultCode =="
    ...
    const-string v4, "Profile onActivityResult() data != null"
    ...
    const-string v5, "Profile onActivityResult() data.getData() =="
    ...
    :try_start_0
    iget v4, p0, Lcom/android/internal/app/RingtonePickerActivity;->mExternalType:I
    ...
    invoke-virtual {p0}, Lcom/android/internal/app/RingtonePickerActivity;->getContentResolver()Landroid/content/ContentResolver;
    ...
    :cond_0
    :goto_0
    iget-boolean v4, p0, Lcom/android/internal/app/RingtonePickerActivity;->mIsProfileMode:Z

    if-nez v4, :cond_4

    const-string v4, "RingtonePickerActivity"

    const-string v4, "Profile onActivityResult() mIsProfileMode = false"
    ...
    const-string v5, "Profile onActivityResult() selectedUri = "
    ...
    .restart local v2       #selectedUri:Landroid/net/Uri;
    :cond_2
    :try_start_1
    iget v4, p0, Lcom/android/internal/app/RingtonePickerActivity;->mExternalType:I
    ...
    const-string v5, "Profile couldn\'t set ringtone flag for  "
    ...
    invoke-virtual {p0, v8, v1}, Lcom/android/internal/app/RingtonePickerActivity;->setResult(ILandroid/content/Intent;)V

    const-string v4, "RingtonePickerActivity"

    const-string v4, "Profile onActivityResult() mIsProfileMode = true"
    ...
    const-string v4, "Profile onActivityResult() resultCode == RESULT_CANCELED"

    invoke-static {v7, v4}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v4, p0, Lcom/android/internal/app/RingtonePickerActivity;->mListView:Landroid/widget/ListView;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput v3, p0, Lcom/android/internal/app/RingtonePickerActivity;->mExternalType:I

    :cond_1
    const-string v4, "android.intent.extra.ringtone.SHOW_EXTERNAL"

    invoke-virtual {v1, v4, v7}, Landroid/content/Intent;->getBooleanExtra(Ljava/lang/String;Z)Z

    move-result v4

    iput-boolean v4, p0, Lcom/android/internal/app/RingtonePickerActivity;->mHasExternalItem:Z

    const-string v4, "android.intent.extra.ringtone.PROFILE_MODE"

    invoke-virtual {v1, v4, v7}, Landroid/content/Intent;->getBooleanExtra(Ljava/lang/String;Z)Z

    move-result v4

    iput-boolean v4, p0, Lcom/android/internal/app/RingtonePickerActivity;->mIsProfileMode:Z
...
.method public onItemSelected(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .prologue
    invoke-virtual {p0}, Lcom/android/internal/app/RingtonePickerActivity;->FMStop()V

    invoke-virtual {p0}, Lcom/android/internal/app/RingtonePickerActivity;->musicServiceStop()V
...
.method protected onPause()V
    ...
    invoke-virtual {p0}, Lcom/android/internal/app/RingtonePickerActivity;->FMStart()V

    invoke-virtual {p0}, Lcom/android/internal/app/RingtonePickerActivity;->musicServiceStart()V
...
.method public onPrepareListView(Landroid/widget/ListView;)V
    ...
    .prologue
    iget-boolean v0, p0, Lcom/android/internal/app/RingtonePickerActivity;->mHasExternalItem:Z

    if-eqz v0, :cond_0

    const v0, 0x10403df

    invoke-direct {p0, p1, v0}, Lcom/android/internal/app/RingtonePickerActivity;->addExternalItem(Landroid/widget/ListView;I)I
