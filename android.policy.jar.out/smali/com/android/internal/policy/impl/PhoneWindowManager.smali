...
.method static synthetic access$000(Lcom/android/internal/policy/impl/PhoneWindowManager;IILjava/lang/String;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
    ...
    .prologue
    invoke-direct {p0, p1, p2, p3}, Lcom/android/internal/policy/impl/PhoneWindowManager;->sendIntents(IILjava/lang/String;)V
...
.method private final sendIntent(IIILjava/lang/String;)V
    ...
    const-string v5, "Headset detect: inside sendIntent() in PhoneMangerWindow()"
    ...
    const-string v6, "Headset detect: Intent.ACTION_HEADSET_PLUG: state: "
...
.method private final declared-synchronized sendIntents(IILjava/lang/String;)V
    ...
    const-string v3, "Headset detect: inside sendIntents() in PhoneMangerWindow()"
    ...
    invoke-direct {p0, v1, p1, p2, p3}, Lcom/android/internal/policy/impl/PhoneWindowManager;->sendIntent(IIILjava/lang/String;)V
...
.method private final declared-synchronized update(Ljava/lang/String;I)V
    ...
    const-string v4, "Headset detect: inside update() in PhoneMangerWindow()"
    ...
    .local v0, delay:I
    iget v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHeadsetState:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iput v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHeadsetState:I
    ...
    iget v6, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHeadsetState:I

    iget v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPrevHeadsetState:I

    iget-object v8, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHeadsetName:Ljava/lang/String;
...
.method public interceptKeyBeforeDispatching(Landroid/view/WindowManagerPolicy$WindowState;IIIIIII)Z
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->isInEmode()Z
...
.method public notifyJackSwitchChanged(JIZ)V
    ...
    const-string v1, "Headset detect: inside notifyJackSwitchChanged() in PhoneMangerWindow()"
    ...
    :goto_0
    invoke-direct {p0, v0, v1}, Lcom/android/internal/policy/impl/PhoneWindowManager;->update(Ljava/lang/String;I)V
